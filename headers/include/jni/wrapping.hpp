...
template <class W, class U> auto Wrap(U &&u)
{
    return Wrapper<W>().Wrap(std::forward<U>(u));
}

template <class W> auto Unwrap(W &&w)
{
    return Wrapper<typename std::decay<W>::type>().Unwrap(std::forward<W>(w));
}

template <class T> using UnwrappedType = decltype(Unwrap<T>(std::declval<T>()));

template <class T> struct PrimitiveTypeWrapper
{
...
template <> struct Wrapper<const char16_t *>
{
...
template <> struct Wrapper<char16_t *>
{
...
template <class W, class U> struct ReferenceTypeWrapper
{
...
template <>
struct Wrapper<jthrowable *> : ReferenceTypeWrapper<jthrowable, ::jthrowable>
{
};

template <>
struct Wrapper<jarray<jobject> *>
    : ReferenceTypeWrapper<jarray<jobject>, ::jobjectArray>
{
};
template <>
struct Wrapper<jarray<jboolean> *>
    : ReferenceTypeWrapper<jarray<jboolean>, ::jbooleanArray>
{
};
template <>
struct Wrapper<jarray<jbyte> *>
    : ReferenceTypeWrapper<jarray<jbyte>, ::jbyteArray>
{
};
template <>
struct Wrapper<jarray<jchar> *>
    : ReferenceTypeWrapper<jarray<jchar>, ::jcharArray>
{
};
template <>
struct Wrapper<jarray<jshort> *>
    : ReferenceTypeWrapper<jarray<jshort>, ::jshortArray>
{
};
template <>
struct Wrapper<jarray<jint> *> : ReferenceTypeWrapper<jarray<jint>, ::jintArray>
{
};
template <>
struct Wrapper<jarray<jlong> *>
    : ReferenceTypeWrapper<jarray<jlong>, ::jlongArray>
{
};
template <>
struct Wrapper<jarray<jfloat> *>
    : ReferenceTypeWrapper<jarray<jfloat>, ::jfloatArray>
{
};
template <>
struct Wrapper<jarray<jdouble> *>
    : ReferenceTypeWrapper<jarray<jdouble>, ::jdoubleArray>
{
};

template <>
struct Wrapper<jfieldID *> : ReferenceTypeWrapper<jfieldID, ::jfieldID>
{
};
template <>
struct Wrapper<jmethodID *> : ReferenceTypeWrapper<jmethodID, ::jmethodID>
{
};

// Allow references to be unwrapped to pointers to the underlying type, but not
// the reverse, because dereferences should be explicit, with null checks where
// necessary.

template <class W, class U> struct ReferenceTypeUnwrapper
{
    U Unwrap(W &w) const { return reinterpret_cast<U>(&w); }
};
...
template <>
struct Wrapper<jthrowable> : ReferenceTypeUnwrapper<jthrowable, ::jthrowable>
{
};

template <>
struct Wrapper<jarray<jobject>>
    : ReferenceTypeUnwrapper<jarray<jobject>, ::jobjectArray>
{
};
template <>
struct Wrapper<jarray<jboolean>>
    : ReferenceTypeUnwrapper<jarray<jboolean>, ::jbooleanArray>
{
};
template <>
struct Wrapper<jarray<jbyte>>
    : ReferenceTypeUnwrapper<jarray<jbyte>, ::jbyteArray>
{
};
template <>
struct Wrapper<jarray<jchar>>
    : ReferenceTypeUnwrapper<jarray<jchar>, ::jcharArray>
{
};
template <>
struct Wrapper<jarray<jshort>>
    : ReferenceTypeUnwrapper<jarray<jshort>, ::jshortArray>
{
};
template <>
struct Wrapper<jarray<jint>> : ReferenceTypeUnwrapper<jarray<jint>, ::jintArray>
{
};
template <>
struct Wrapper<jarray<jlong>>
    : ReferenceTypeUnwrapper<jarray<jlong>, ::jlongArray>
{
};
template <>
struct Wrapper<jarray<jfloat>>
    : ReferenceTypeUnwrapper<jarray<jfloat>, ::jfloatArray>
{
};
template <>
struct Wrapper<jarray<jdouble>>
    : ReferenceTypeUnwrapper<jarray<jdouble>, ::jdoubleArray>
{
};

template <>
struct Wrapper<jfieldID> : ReferenceTypeUnwrapper<jfieldID, ::jfieldID>
{
};
template <>
struct Wrapper<jmethodID> : ReferenceTypeUnwrapper<jmethodID, ::jmethodID>
{
};
...
{
    ::JNINativeMethod
    Unwrap(JNINativeMethod<R(JNIEnv *, T *, Args...)> method) const
    {
...
template <> struct Wrapper<version>
{
