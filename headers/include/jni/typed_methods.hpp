...
template <> struct TypedMethods<jboolean>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualBooleanMethod;
...
template <> struct TypedMethods<jbyte>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualByteMethod;
...
template <> struct TypedMethods<jint>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualIntMethod;
...
template <> struct TypedMethods<jlong>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualLongMethod;
...
template <> struct TypedMethods<jfloat>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualFloatMethod;
...
template <> struct TypedMethods<jdouble>
{
    ...
    static constexpr auto CallNonvirtualMethod =
        &JNIEnv::CallNonvirtualDoubleMethod;
