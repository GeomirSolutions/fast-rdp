...
struct IsArraylike<std::array<E, n>> : std::true_type
{
};
...
template <class E, std::size_t n> struct ArraylikeElementType<E[n]>
{
    using Type = E;
};
template <class E, std::size_t n> struct ArraylikeElementType<std::array<E, n>>
{
    using Type = E;
};
template <class E, class A> struct ArraylikeElementType<std::vector<E, A>>
{
    using Type = E;
};
template <class C, class T, class A>
...
template <class E, std::size_t n> E *ArraylikeData(std::array<E, n> &a)
{
    return a.data();
}
template <class E, std::size_t n>
...
template <class E, class A> E *ArraylikeData(std::vector<E, A> &a)
{
    return a.data();
}
template <class E, class A> E const *ArraylikeData(const std::vector<E, A> &a)
{
    return a.data();
}
template <class C, class T, class A>
...
template <class E, std::size_t n> std::size_t ArraylikeSize(E (&)[n])
{
    return n;
}
template <class E, std::size_t n>
