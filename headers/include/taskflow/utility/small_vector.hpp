  ...
  protected:
    ...
    void grow_pod(void *FirstEl, size_t MinSizeInBytes, size_t TSize)
    {
        ...
        if (BeginX == FirstEl) {
            ...
            // If this wasn't grown from the inline copy, grow the allocated
            // space.
...
class SmallVector : public SmallVectorImpl<T>
{
  ...
  public:
    ...
    */
    ...
    /**
    @brief replaces the contents with the copy of the contents of an initializer
    list @c IL
     */
...
template <typename T>
inline void swap(tf::SmallVectorImpl<T> &LHS, tf::SmallVectorImpl<T> &RHS)
{
    LHS.swap(RHS);
}
...
/// Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(tf::SmallVector<T, N> &LHS, tf::SmallVector<T, N> &RHS)
{
    LHS.swap(RHS);
}
} // namespace std
