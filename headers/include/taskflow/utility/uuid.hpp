...
// software construction. A UUID is simply a 128-bit value. The meaning of each
// bit is defined by any of several variants. For human-readable display, many
// systems use a canonical format using hexadecimal text with inserted hyphen
// characters.
//
...
// Function: size
inline typename UUID::size_type UUID::size() { return 16; }

// Function: begin
inline typename UUID::iterator UUID::begin() { return data; }

// Function: begin
inline typename UUID::const_iterator UUID::begin() const { return data; }

// Function: end
inline typename UUID::iterator UUID::end() { return data + size(); }

// Function: end
inline typename UUID::const_iterator UUID::end() const { return data + size(); }
