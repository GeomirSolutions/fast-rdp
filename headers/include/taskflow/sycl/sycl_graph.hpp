...
class syclGraph : public CustomGraphBase
{
  ...
  public:
    ...
    template <typename... ArgsT> syclNode *emplace_back(ArgsT &&...);
...
class syclNode
{
    ...
    struct CGH
    {
        ...
        template <typename F> CGH(F &&func) : work{std::forward<F>(func)} {}
    };

    using handle_t = std::variant<Empty, CGH>;
  ...
  public:
    ...
    template <typename... ArgsT> syclNode(syclGraph &, ArgsT &&...);
...
syclNode::syclNode(syclGraph &g, ArgsT &&...args)
    : _graph{g}, _handle{std::forward<ArgsT>(args)...}
{
}
...
// Move constructor
inline syclGraph::syclGraph(syclGraph &&g) : _nodes{std::move(g._nodes)}
{
...
// Function: empty
inline bool syclGraph::empty() const { return _nodes.empty(); }
...
template <typename... ArgsT> syclNode *syclGraph::emplace_back(ArgsT &&...args)
{
...
inline void syclGraph::dump(std::ostream &os, const void *root,
