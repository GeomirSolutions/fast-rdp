...
template <typename Iter, typename Compare>
void parallel_pdqsort(tf::Subflow &sf, Iter begin, Iter end, Compare comp,
                      int bad_allowed, bool leftmost = true)
{
    ...
    while (true) {
        ...
        // of a previous partition operation, there is no element in [begin,
        // end) that is smaller than *(begin - 1). Then if our pivot compares
        // equal to *(begin - 1) we change strategy, putting equal elements in
        ...
        sf.silent_async([&sf, begin, pivot_pos, comp, bad_allowed,
                         leftmost]() mutable {
