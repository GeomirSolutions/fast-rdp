...
macro(extract_version_from_changelog)
  execute_process(
    COMMAND
      bash "-c"
      "grep -m1 -E '^# v[0-9]+\.[0-9]+\.[0-9]+.*' CHANGELOG.md | cut -c 4-"
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR}
  ...
  string(REGEX MATCH "^([0-9]+)\\.([0-9]+)\\.([0-9]+)(.*)" VERSION_MATCHED
               ${VERSION_FULL})
...
macro(configure_version_h)
  ...
  if(CUBAO_USE_DUMMY_VERSION_H STREQUAL "True")
    configure_file(${CUBAO_UTILS_CMAKE_DIRNAME}/version.h.dummy.in ${VERSION_H}
                   @ONLY)
  else()
