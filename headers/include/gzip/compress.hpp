...
class Compressor
{
  ...
  public:
    ...
    void compress(InputType &output, const char *data, std::size_t size) const
    {
        ...
        // in better compression at the expense of memory usage. This range of
        // values also changes the decoding type:
...
#pragma GCC diagnostic pop
        ...
        do {
            ...
            // "deflate() has a return value that can indicate errors, yet we do
            // not check it here. Why not? Well, it turns out that deflate() can
            // do no wrong here." Basically only possible error is from
            // deflateInit not working properly
