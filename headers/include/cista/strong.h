...
template <typename T> struct is_strong : std::false_type
{
};
...
template <typename T> T to_idx(T const &t) { return t; }
...
template <typename T, typename Tag> class numeric_limits<cista::strong<T, Tag>>
{
  public:
