...
template <typename DataVec, typename IndexVec> struct fws_multimap_entry
{
...
template <typename MapType, typename EntryType> struct fws_multimap_iterator
{
...
template <typename DataVec, typename IndexVec> struct fws_multimap
{
    using value_t = typename DataVec::value_type;
    using index_t = typename IndexVec::value_type;
