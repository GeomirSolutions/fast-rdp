    ...
    P
{
  ...
  public:
     ...
     */
    constexpr iterator_range() : P{iterator{}, iterator{}} {}
     ...
     */
    constexpr iterator_range(iterator &&first_iterator,
    ...
    constexpr iterator begin() const noexcept { return this->first; }

    /// Return iterator to end of range.
    constexpr iterator end() const noexcept { return this->second; }

    /// Return iterator to beginning of range.
    constexpr iterator cbegin() const noexcept { return this->first; }

    /// Return iterator to end of range.
    constexpr iterator cend() const noexcept { return this->second; }
 ...
 */
template <typename T> class const_fixed_iterator
{
  ...
  public:
    ...
    explicit const_fixed_iterator(const char *data) noexcept : m_data{data} {}
    ...
    operator=(const const_fixed_iterator &) noexcept = default;
    ...
    friend bool operator==(const_fixed_iterator lhs,
                           const_fixed_iterator rhs) noexcept
    {
    ...
    friend const_fixed_iterator operator+(const_fixed_iterator lhs,
    ...
    friend const_fixed_iterator operator+(difference_type lhs,
                                          const_fixed_iterator rhs) noexcept
    {
    ...
    friend difference_type operator-(const_fixed_iterator lhs,
                                     const_fixed_iterator rhs) noexcept
    {
        return static_cast<difference_type>(lhs.m_data - rhs.m_data) /
 ...
 */
template <typename T> class const_varint_iterator
{
  ...
  public:
    ...
    static difference_type distance(const_varint_iterator begin,
                                    const_varint_iterator end) noexcept
    {
    ...
    operator=(const const_varint_iterator &) noexcept = default;
    const_varint_iterator &
    operator=(const_varint_iterator &&) noexcept = default;
...
class const_svarint_iterator : public const_varint_iterator<T>
{
  ...
  public:
    ...
    const_svarint_iterator() noexcept : const_varint_iterator<T>{} {}
    ...
    const_svarint_iterator &
    operator=(const_svarint_iterator &&) noexcept = default;
    ...
    value_type operator*() const
    {
        ...
        return static_cast<value_type>(
            decode_zigzag64(decode_varint(&d, this->m_end)));
    }
...
distance<protozero::const_varint_iterator<int32_t>>(
    protozero::const_varint_iterator<int32_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
...
distance<protozero::const_varint_iterator<int64_t>>(
    protozero::const_varint_iterator<int64_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
...
distance<protozero::const_varint_iterator<uint32_t>>(
    protozero::const_varint_iterator<uint32_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
...
distance<protozero::const_varint_iterator<uint64_t>>(
    protozero::const_varint_iterator<uint64_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
...
distance<protozero::const_svarint_iterator<int32_t>>(
    protozero::const_svarint_iterator<int32_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
...
distance<protozero::const_svarint_iterator<int64_t>>(
    protozero::const_svarint_iterator<int64_t>
        first, // NOLINT(readability-inconsistent-declaration-parameter-name)
