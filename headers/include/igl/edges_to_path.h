...
/// @param[out] I  #E+1 list of nodes in order tracing the chain (loop), if the
/// output
///     is a loop then I(1) == I(end)
/// @param[out] J  #I-1 list of indices into E of edges tracing I
/// @param[out] K  #I-1 list of indices into columns of E {0,1} so that K(i)
/// means that
...
///
template <typename DerivedE, typename DerivedI, typename DerivedJ,
          typename DerivedK>
IGL_INLINE void edges_to_path(const Eigen::MatrixBase<DerivedE> &E,
