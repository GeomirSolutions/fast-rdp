...
//    stock IJG lib) PNG 1/2/4/8/16-bit-per-channel TGA (not sure what subset,
//    if a subset) BMP non-1bpp, non-RLE PSD (composited view only, no extra
//    channels, 8/16 bit-per-channel)
...
//
IGL_INLINE bool
read_image(const std::string image_file,
