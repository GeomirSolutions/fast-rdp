                                   ...
                                   const char *file_name)
{
    ...
    for (std::vector<::igl::anttweakbar::ReTwCBItem>::const_iterator it =
        ...
        // I'm not sure how to do what I want to do. getCallback needs to be
        // sure that it can write to var. So var needs to point to a valid and
        // big enough chunk of memory
