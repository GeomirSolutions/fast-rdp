...
IGL_INLINE void igl::is_delaunay(const Eigen::MatrixBase<DerivedV> &V,
                                 const Eigen::MatrixBase<DerivedF> &F,
                                 Eigen::PlainObjectBase<DerivedD> &D)
{
    typedef typename DerivedV::Scalar Scalar;
    // Should use Shewchuk's predicates instead.
    const auto float_incircle = [](const Scalar pa[2], const Scalar pb[2],
                                   const Scalar pc[2],
                                   const Scalar pd[2]) -> short {
        // I acknowledge that I am cating to double
        const Eigen::Matrix3d A =
            (Eigen::Matrix3d(3, 3) << pa[0] - pd[0], pa[1] - pd[1],
             (pa[0] - pd[0]) * (pa[0] - pd[0]) +
                 (pa[1] - pd[1]) * (pa[1] - pd[1]),
             pb[0] - pd[0], pb[1] - pd[1],
             (pb[0] - pd[0]) * (pb[0] - pd[0]) +
...
IGL_INLINE bool igl::is_delaunay(const Eigen::MatrixBase<DerivedV> &V,
                                 const Eigen::MatrixBase<DerivedF> &F,
...
template void igl::is_delaunay<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<bool, -1, 3, 0, -1, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<bool, -1, 3, 0, -1, 3>> &);
// generated by autoexplicit.sh
template void igl::is_delaunay<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
// generated by autoexplicit.sh
template bool igl::is_delaunay<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<int, -1, -1, 0, -1, -1>, int,
                               short (*)(double const *, double const *,
    ...
    unsigned long);
#ifdef WIN32
template bool igl::is_delaunay<class Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    class std::vector<class std::vector<int, class std::allocator<int>>,
                      class std::allocator<class std::vector<
                          int, class std::allocator<int>>>> const &,
    short (*const)(double const *, double const *, double const *,
                   double const *),
    unsigned __int64);
#endif
#endif
