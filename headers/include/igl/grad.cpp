                         ...
                         bool uniform)
{
    ...
    if (!uniform) {
        ...
        for (int i = 0; i < m; i++) {
            N.row(0 * m + i) << 0, 0, 1;
            double a =
                sqrt(2) * std::cbrt(3 * vol(i)); // area of a face in a uniform
                                                 // tet with volume = vol(i)
                         ...
                         bool uniform)
{
    ...
    for (int i = 0; i < m; ++i) {
        ...
        // #F x 3 matrices of triangle edge vectors, named after opposite
        // vertices
        ...
        // This does correct l2 norm of rows, so that it contains #F list of
        // twice triangle areas
