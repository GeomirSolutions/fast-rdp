...
/// @param[out] A   #T by 4 list of face areas corresponding to faces opposite
/// vertices
///     0,1,2,3
///
template <typename DerivedV, typename DerivedT, typename DerivedA>
IGL_INLINE void face_areas(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void face_areas(const Eigen::MatrixBase<DerivedL> &L,
                           Eigen::PlainObjectBase<DerivedA> &A);
/// \overload
///
...
template <typename DerivedL, typename DerivedA>
IGL_INLINE void
face_areas(const Eigen::MatrixBase<DerivedL> &L,
