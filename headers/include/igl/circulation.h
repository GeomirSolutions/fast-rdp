...
/// @param[in] ccw  whether to _continue_ in ccw direction of edge (circulate
/// around
///     E(e,1))
...
///
/// \see edge_flaps
IGL_INLINE std::vector<int> circulation(const int e, const bool ccw,
...
///     e=(j->i)
/// @param[in] EI  #E by 2 list of edge flap corners (see above).
/// @param[out] #vN list of of faces touched by circulation (in cyclically
/// order).
///
/// \see edge_flaps
...
IGL_INLINE void circulation(const int e, const bool ccw,
                            ...
                            const Eigen::MatrixXi &EI,
                            /*std::vector<int> & Ne,*/
                            std::vector<int> &Nv, std::vector<int> &Nf);
} // namespace igl
