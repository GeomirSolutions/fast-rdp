...
template void igl::flip_edge<
    ...
    int>(Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
         ...
         unsigned long);
template void igl::flip_edge<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
template void igl::flip_edge<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
    ...
    std::vector<std::vector<int, std::allocator<int>>,
                std::allocator<std::vector<int, std::allocator<int>>>> &,
    unsigned __int64);
template void igl::flip_edge<class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                             class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                             class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                             class Eigen::Matrix<int, -1, 1, 0, -1, 1>, int>(
