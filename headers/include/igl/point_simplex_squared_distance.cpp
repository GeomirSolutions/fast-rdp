...
template <int DIM, typename Derivedp, typename DerivedV, typename DerivedEle,
...
IGL_INLINE void igl::point_simplex_squared_distance(
    ...
    const typename DerivedEle::Index primitive, Derivedsqr_d &sqr_d,
    Eigen::PlainObjectBase<Derivedc> &c, Eigen::PlainObjectBase<Derivedb> &bary)
{
    ...
    assert(((Derivedb::RowsAtCompileTime == -1 ||
             Derivedb::ColsAtCompileTime == -1) ||
            (Derivedb::RowsAtCompileTime == Ele.cols() ||
             Derivedb::ColsAtCompileTime == Ele.cols())) &&
           "bary must be Dynamic or size of Ele.cols()");

    BaryPoint tmp_bary;
    c = (const Derivedc &)ClosestBaryPtPointTriangle(
        p, V.row(Ele(primitive, 0)),
        ...
        V.row(Ele(primitive, 2 % Ele.cols())), tmp_bary);
    bary.resize(Derivedb::RowsAtCompileTime == 1 ? 1 : Ele.cols(),
                Derivedb::ColsAtCompileTime == 1 ? 1 : Ele.cols());
    bary.head(Ele.cols()) = tmp_bary.head(Ele.cols());
    sqr_d = (p - c).squaredNorm();
}

template <int DIM, typename Derivedp, typename DerivedV, typename DerivedEle,
          typename Derivedsqr_d, typename Derivedc>
IGL_INLINE void igl::point_simplex_squared_distance(
    const Eigen::MatrixBase<Derivedp> &p, const Eigen::MatrixBase<DerivedV> &V,
    const Eigen::MatrixBase<DerivedEle> &Ele,
    const typename DerivedEle::Index primitive, Derivedsqr_d &sqr_d,
    Eigen::PlainObjectBase<Derivedc> &c)
{
    ...
    Eigen::Matrix<typename Derivedc::Scalar, 1, DerivedEle::ColsAtCompileTime>
        b;
...
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<double, 1, 3, 1, 1, 3>,
    ...
    Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &);
// generated by autoexplicit.sh
template void
igl::point_simplex_squared_distance<2, Eigen::Matrix<double, 1, 2, 1, 1, 2>,
                                    Eigen::Matrix<double, -1, 2, 0, -1, 2>,
                                    Eigen::Matrix<int, -1, 2, 0, -1, 2>, double,
    ...
    Eigen::Matrix<int, -1, 2, 0, -1, 2>::Index, double &,
...
igl::point_simplex_squared_distance<3, Eigen::Matrix<double, 1, 3, 1, 1, 3>,
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<double, 1, 3, 1, 1, 3>,
                                    Eigen::Matrix<double, -1, 3, 1, -1, 3>,
    ...
    Eigen::Matrix<int, -1, 3, 1, -1, 3>::Index, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<float, 1, 3, 1, 1, 3>,
                                    Eigen::Matrix<float, -1, 3, 0, -1, 3>,
                                    Eigen::Matrix<int, -1, 3, 0, -1, 3>, float,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    Eigen::Matrix<int, -1, 3, 0, -1, 3>::Index, float &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<float, 1, 3, 1, 1, 3>,
                                    Eigen::Matrix<float, -1, 3, 1, -1, 3>,
                                    Eigen::Matrix<int, -1, 3, 1, -1, 3>, float,
                                    Eigen::Matrix<float, 1, 3, 1, 1, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, -1, 3, 1, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &,
    Eigen::Matrix<int, -1, 3, 1, -1, 3>::Index, float &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<float, 1, 3, 1, 1, 3>,
                                    Eigen::Matrix<float, -1, 3, 1, -1, 3>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<float, -1, 3, 1, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index, float &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<3, Eigen::Matrix<double, 1, 3, 1, 1, 3>,
...
igl::point_simplex_squared_distance<3, Eigen::Matrix<double, 1, 3, 1, 1, 3>,
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 1, 1, 3>> &);
template void
igl::point_simplex_squared_distance<2, Eigen::Matrix<double, 1, 2, 1, 1, 2>,
                                    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                    Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
igl::point_simplex_squared_distance<2, Eigen::Matrix<double, 1, 2, 1, 1, 2>,
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>::Index, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 2, 1, 1, 2>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 2, 1, 1, 1, 2>> &);
template void
igl::point_simplex_squared_distance<2, Eigen::Matrix<double, 1, 2, 1, 1, 2>,
                                    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
