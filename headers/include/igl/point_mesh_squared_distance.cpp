...
template <int DIM, typename DerivedP, typename DerivedV, typename DerivedEle,
          typename DerivedsqrD, typename DerivedI, typename DerivedC>
...
// not.
template <typename DerivedP, typename DerivedV, typename DerivedEle,
          typename DerivedsqrD, typename DerivedI, typename DerivedC,
          bool DynamicCols>
...
template <typename DerivedP, typename DerivedV, typename DerivedEle,
          typename DerivedsqrD, typename DerivedI, typename DerivedC>
struct point_mesh_squared_distance_DIM_Handler<
    DerivedP, DerivedV, DerivedEle, DerivedsqrD, DerivedI, DerivedC, true>
{
...
template <typename DerivedP, typename DerivedV, typename DerivedEle,
          typename DerivedsqrD, typename DerivedI, typename DerivedC>
struct point_mesh_squared_distance_DIM_Handler<
    DerivedP, DerivedV, DerivedEle, DerivedsqrD, DerivedI, DerivedC, false>
{
    static void compute(const Eigen::MatrixBase<DerivedP> &P,
                        const Eigen::MatrixBase<DerivedV> &V,
                        const Eigen::MatrixBase<DerivedEle> &Ele,
...
#ifdef WIN32
template void
igl::point_mesh_squared_distance<class Eigen::Matrix<double, -1, -1, 0, -1, -1>,
