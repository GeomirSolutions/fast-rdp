...
IGL_INLINE void igl::snap_points(const Eigen::MatrixBase<DerivedC> &C,
...
IGL_INLINE void igl::snap_points(const Eigen::MatrixBase<DerivedC> &C,
                                 ...
                                 Eigen::PlainObjectBase<DerivedI> &I)
{
    Eigen::Matrix<typename DerivedC::Scalar, DerivedC::RowsAtCompileTime, 1>
        minD;
...
template void igl::snap_points<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                               Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
