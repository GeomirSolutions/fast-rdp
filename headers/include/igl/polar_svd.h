...
/// @param[in] includeReflections  Whether to force R to be a rotation, or allow
/// it to be a reflection
/// @param[out] R  3 by 3 rotation matrix part of decomposition (**always
/// rotataion**)
...
IGL_INLINE void polar_svd(const Eigen::MatrixBase<DerivedA> &A,
