                                     ...
                                     std::vector<std::vector<uE2EType>> &uE2E)
{
    ...
    for_each(uE2E.begin(), uE2E.end(),
             [](vector<uE2EType> &v) { v.reserve(2); });
                                     ...
                                     Eigen::PlainObjectBase<DerivedEMAP> &EMAP)
{
    ...
    oriented_facets(F, E);
    const size_t ne = E.rows();
    // This is 2x faster to create than a map from pairs to lists of edges and
    // 5x faster to access (actually access is probably assympotically faster
    // O(1) vs. O(log m)
                                     ...
                                     Eigen::PlainObjectBase<DeriveduEE> &uEE)
{
    ...
    typedef Eigen::Matrix<typename DeriveduEC::Scalar, Eigen::Dynamic, 1>
        VectorXI;
    VectorXI uEK;
...
template void igl::unique_edge_map<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
#ifdef WIN32
template void __cdecl igl::unique_edge_map<
    class Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    class Eigen::Matrix<int, -1, 1, 0, -1, 1>, unsigned __int64>(
    class Eigen::MatrixBase<class Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
...
// generated by autoexplicit.sh
template void
igl::unique_edge_map<Eigen::Matrix<int, -1, 3, 0, -1, 3>,
...
// generated by autoexplicit.sh
template void
igl::unique_edge_map<Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>,
                     Eigen::Matrix<unsigned int, -1, 2, 0, -1, 2>,
                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<unsigned int, -1, 2, 0, -1, 2>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
// generated by autoexplicit.sh
...
template void igl::unique_edge_map<
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void
igl::unique_edge_map<Eigen::Matrix<int, -1, 3, 1, -1, 3>,
                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, 1, 0, -1, 1>, unsigned long>(
...
template void igl::unique_edge_map<
    ...
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    int>(Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
         Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
         Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
         Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
         std::vector<std::vector<int, std::allocator<int>>,
...
template void igl::unique_edge_map<
    ...
    int>(Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
         ...
         std::vector<std::vector<int, std::allocator<int>>,
                     std::allocator<std::vector<int, std::allocator<int>>>> &);
template void
igl::unique_edge_map<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     Eigen::Matrix<int, -1, 1, 0, -1, 1>, unsigned long>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
...
#ifdef WIN32
template void
igl::unique_edge_map<class Eigen::Matrix<int, -1, 3, 0, -1, 3>,
                     class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                     class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                     class Eigen::Matrix<__int64, -1, 1, 0, -1, 1>, __int64>(
    class Eigen::MatrixBase<class Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, 2, 0, -1, 2>> &,
    class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, 2, 0, -1, 2>> &,
...
template void
igl::unique_edge_map<class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                     class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                     class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                     class Eigen::Matrix<__int64, -1, 1, 0, -1, 1>, __int64>(
    ...
    class std::vector<class std::vector<__int64, class std::allocator<__int64>>,
                      class std::allocator<class std::vector<
                          __int64, class std::allocator<__int64>>>> &);
template void igl::unique_edge_map<class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
    ...
    class std::vector<
        ...
        class std::allocator<class std::vector<
            unsigned __int64, class std::allocator<unsigned __int64>>>> &);
template void igl::unique_edge_map<class Eigen::Matrix<int, -1, 3, 1, -1, 3>,
                                   class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                   class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                   class Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                                   unsigned __int64>(
