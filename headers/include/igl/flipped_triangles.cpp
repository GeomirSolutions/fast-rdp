...
// <michaelrabinovich27@gmail.com@gmail.com>
//
...
IGL_INLINE void igl::flipped_triangles(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE Eigen::VectorXi
igl::flipped_triangles(const Eigen::MatrixBase<DerivedV> &V,
                       const Eigen::MatrixBase<DerivedF> &F)
{
    Eigen::VectorXi X;
...
template void igl::flipped_triangles<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
igl::flipped_triangles<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                       Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &);
#endif
