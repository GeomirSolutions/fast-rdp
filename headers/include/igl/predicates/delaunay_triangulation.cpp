...
IGL_INLINE void
igl::predicates::delaunay_triangulation(const Eigen::MatrixBase<DerivedV> &V,
                                        Eigen::PlainObjectBase<DerivedF> &F)
{
    ...
    const auto incircle = [](const double *pa, const double *pb,
...
template igl::predicates::delaunay_triangulation<
