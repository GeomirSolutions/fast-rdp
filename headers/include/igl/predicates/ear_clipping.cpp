...
template <typename DerivedP, typename DerivedRT, typename DerivedF,
          typename DerivedI>
IGL_INLINE void
igl::predicates::ear_clipping(const Eigen::MatrixBase<DerivedP> &P,
                              ...
                              Eigen::PlainObjectBase<DerivedI> &I)
{
    ...
    auto is_ear = [](const Eigen::MatrixBase<DerivedP> &P,
                     const Eigen::MatrixBase<DerivedRT> &RT,
        ...
        if (r == igl::predicates::Orientation::NEGATIVE ||
            r == igl::predicates::Orientation::COLLINEAR)
            return false;
                              ...
                              Eigen::PlainObjectBase<DerivedF> &eF)
{
    ...
    const Eigen::Matrix<typename DerivedP::Scalar, Eigen::Dynamic, 1> RT =
        Eigen::Matrix<typename DerivedP::Scalar, Eigen::Dynamic, 1>::Zero(
            P.rows());
...
template bool
igl::predicates::ear_clipping<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
