    ...
    while (phase < 3) {
        ...
        while (true) {
            if (MAXIT > 0 && it >= MAXIT) {
                ...
                cerr << "linprog: warning! maximum iterations without "
                        "convergence."
                     << endl;
#endif
                success = false;
            ...
            if (df >= 0) {
                ...
                // again seems like q is assumed to be a scalar though matlab
                // code could produce a vector for multiple matches
            ...
            int p;
            {
                ...
                if (df >= 0) {
                    ...
                    // code down the line seems to assume p is a scalar though
                    // the matlab code could find a vector of matches)
