...
template <> struct moments_resize_3<true, false>
{
    ...
    static void run(Eigen::PlainObjectBase<Derivedm1> &m1)
    {
        static_assert(Derivedm1::ColsAtCompileTime == Eigen::Dynamic ||
                          Derivedm1::ColsAtCompileTime == 3,
                      "#cols must be 3 or dynamic");
        m1.resize(1, 3);
    }
};
template <> struct moments_resize_3<false, true>
{
    ...
    static void run(Eigen::PlainObjectBase<Derivedm1> &m1)
    {
        static_assert(Derivedm1::RowsAtCompileTime == Eigen::Dynamic ||
                          Derivedm1::RowsAtCompileTime == 3,
                      "#rows must be 3 or dynamic");
        m1.resize(3, 1);
    }
};
} // namespace igl

template <typename DerivedV, typename DerivedF, typename Derivedm0,
          typename Derivedm1, typename Derivedm2>
IGL_INLINE void igl::moments(const Eigen::MatrixBase<DerivedV> &V,
                             ...
                             Eigen::PlainObjectBase<Derivedm2> &m2)
{
    ...
    m0 = 0;
    moments_resize_3<Derivedm1::RowsAtCompileTime == 1,
                     Derivedm1::ColsAtCompileTime == 1>::run(m1);
    ...
    for (int f = 0; f < F.rows(); f++) {
        ...
        // Mesh" (The attached code has a sign bug in I, fixed below.)
        ...
        // Signed volume
        const Scalar v = x1 * y2 * z3 + y1 * z2 * x3 + x2 * y3 * z1 -
...
template void igl::moments<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::moments<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                           Eigen::Matrix<int, -1, -1, 0, -1, -1>, double,
                           Eigen::Matrix<double, 1, 3, 0, 3, 1>,
                           Eigen::Matrix<double, 3, 3, 0, 3, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, 3, 0, -1, -1>,
                           Eigen::Matrix<int, -1, 3, 0, -1, -1>, double,
                           Eigen::Matrix<double, 3, 1, 0, 3, 1>,
                           Eigen::Matrix<double, 3, 3, 0, 3, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, -1>> const &, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, 3, 0, -1, -1>,
                           Eigen::Matrix<int, -1, 3, 0, -1, -1>, double,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                           Eigen::Matrix<int, -1, -1, 1, -1, -1>, double,
                           Eigen::Matrix<double, 3, 1, 0, 3, 1>,
                           Eigen::Matrix<double, 3, 3, 0, 3, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 1, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 1, -1, -1>> const &, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                           Eigen::Matrix<int, -1, -1, 1, -1, -1>, double,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, 3, 1, -1, -1>,
                           Eigen::Matrix<int, -1, 3, 1, -1, -1>, double,
                           Eigen::Matrix<double, 3, 1, 0, 3, 1>,
                           Eigen::Matrix<double, 3, 3, 0, 3, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 1, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, -1>> const &, double &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 3, 3, 0, 3, 3>> &);
template void igl::moments<Eigen::Matrix<double, -1, 3, 1, -1, -1>,
                           Eigen::Matrix<int, -1, 3, 1, -1, -1>, double,
