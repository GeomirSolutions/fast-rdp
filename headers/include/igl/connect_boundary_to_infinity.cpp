...
IGL_INLINE void
igl::connect_boundary_to_infinity(const Eigen::MatrixBase<DerivedF> &F,
...
template <typename DerivedV, typename DerivedF, typename DerivedVO,
          typename DerivedFO>
IGL_INLINE void
igl::connect_boundary_to_infinity(const Eigen::MatrixBase<DerivedV> &V,
...
template void
igl::connect_boundary_to_infinity<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
