...
/// @param[in] lower_bound  lower bound of distances needed
/// {std::numeric_limits::min}
/// @param[in] upper_bound  lower bound of distances needed
...
signed_distance_pseudonormal(const AABB<DerivedV, 3> &tree,
...
///
/// @param[in] tree  AABB acceleration tree (see
/// cgal/point_mesh_squared_distance.h)
