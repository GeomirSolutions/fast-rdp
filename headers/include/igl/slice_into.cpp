                                ...
                                Eigen::SparseMatrix<T> &Y)
{
    ...
    for (int c = 0; c < C.size(); c++) {
        ...
        // implicit zeros
        for (typename Eigen::SparseMatrix<T>::InnerIterator yit(Y, k); yit;
             ++yit) {
            if (in_R[yit.row()]) {
                Yk.coeffRef(yit.row()) = 0;
            }
        }
        // explicit values
        for (typename Eigen::SparseMatrix<T>::InnerIterator xit(X, c); xit;
             ++xit) {
            // row in X
            int r = xit.row();
            // row in Y
...
template <typename DerivedX, typename DerivedY, typename DerivedR,
          typename DerivedC>
IGL_INLINE void igl::slice_into(const Eigen::MatrixBase<DerivedX> &X,
                                const Eigen::MatrixBase<DerivedR> &R,
                                const Eigen::MatrixBase<DerivedC> &C,
...
template void igl::slice_into<Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    ...
    Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
// generated by autoexplicit.sh
template void igl::slice_into<double, Eigen::Matrix<double, -1, 1, 0, -1, 1>,
...
template void igl::slice_into<double, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::SparseMatrix<double, 0, int> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    Eigen::SparseMatrix<double, 0, int> &);
template void
igl::slice_into<Eigen::Matrix<double, -1, 1, 0, -1, 1>,
                Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>>,
                Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::Matrix<double, -1, 1, 0, -1, 1> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &, int,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void igl::slice_into<
    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>>,
    Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::Matrix<double, -1, -1, 0, -1, -1> const &,
...
igl::slice_into<Eigen::Matrix<double, -1, 1, 0, -1, 1>,
                Eigen::Matrix<double, -1, 1, 0, -1, 1>,
                Eigen::MatrixWrapper<Eigen::Array<int, -1, 1, 0, -1, 1>>>(
    Eigen::Matrix<double, -1, 1, 0, -1, 1> const &,
    Eigen::MatrixBase<
        Eigen::MatrixWrapper<Eigen::Array<int, -1, 1, 0, -1, 1>>> const &,
