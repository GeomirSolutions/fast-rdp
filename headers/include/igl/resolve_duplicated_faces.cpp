...
IGL_INLINE void
igl::resolve_duplicated_faces(const Eigen::MatrixBase<DerivedF1> &F1,
                              ...
                              Eigen::PlainObjectBase<DerivedJ> &J)
{
    ...
    for (size_t i = 0; i < num_faces; i++) {
        ...
        const bool consistent =
            (F1(i, 0) == uF(ui, 0) && F1(i, 1) == uF(ui, 1) &&
             F1(i, 2) == uF(ui, 2)) ||
            (F1(i, 0) == uF(ui, 1) && F1(i, 1) == uF(ui, 2) &&
             F1(i, 2) == uF(ui, 0)) ||
            (F1(i, 0) == uF(ui, 2) && F1(i, 1) == uF(ui, 0) &&
             F1(i, 2) == uF(ui, 1));
...
template void
igl::resolve_duplicated_faces<Eigen::Matrix<int, -1, 3, 1, -1, 3>,
...
template void
igl::resolve_duplicated_faces<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
#ifdef WIN32
template void
igl::resolve_duplicated_faces<class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
