...
IGL_INLINE void unique_edge_map(const Eigen::MatrixBase<DerivedF> &F,
...
///
/// @param[out] uEC  #uE+1 list of cumulative counts of directed edges sharing
/// each
///     unique edge so the uEC(i+1)-uEC(i) is the number of directed edges
///     sharing the ith unique edge.
/// @param[out] uEE  #E list of indices into E, so that the consecutive segment
/// of
