...
// @param[in] Qi  vector of qnnz row indices of non-zeros in LOWER TRIANGLE ONLY
// of
//       Q⁰
// @param[in] Qj  vector of qnnz column indices of non-zeros in LOWER TRIANGLE
// ONLY
//       of Q⁰
// @param[in] Qv  vector of qnnz values of non-zeros in LOWER TRIANGLE ONLY of
// Q⁰,
//       such that:
//
...
// @param[in] c   (optional) vector of n values of c, transpose of coefficient
// row
//       vector of linear terms, EMPTY means c == 0
// @param[in] cf  (ignored) value of constant term in objective, 0 means cf ==
// 0, so
...
/// \overload
///
/// @param[in] Q  n by n square quadratic coefficients matrix **only lower
/// triangle
///      is used**.
/// @param[in] c  n-long vector of linear coefficients
/// @param[in] cf  constant coefficient
/// @param[in] A  m by n square linear coefficienst matrix of inequality
/// constraints
/// @param[in] lc  m-long vector of lower bounds for linear inequality
/// constraints
/// @param[in] uc  m-long vector of upper bounds for linear inequality
/// constraints
