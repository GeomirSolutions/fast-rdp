...
static void glfw_char_mods_callback(GLFWwindow * /*window*/,
                                    unsigned int codepoint, int modifier)
{
...
IGL_INLINE int Viewer::launch_init(bool fullscreen, const std::string &name,
