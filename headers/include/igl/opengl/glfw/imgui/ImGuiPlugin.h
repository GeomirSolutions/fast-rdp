...
class ImGuiPlugin : public igl::opengl::glfw::ViewerPlugin
{
  ...
  public:
    ...
    // Keyboard IO
    IGL_INLINE virtual bool key_pressed(unsigned int key,
    ...
    IGL_INLINE void draw_text(const Eigen::Vector3d pos,
                              const Eigen::Vector3d normal,
                              const std::string &text,
                              const Eigen::Vector4f color = Eigen::Vector4f(
                                  0, 0, 0.04, 1)); // old default color
