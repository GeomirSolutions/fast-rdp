...
///
/// @param[in] geom_source  string containing source code of geometry shader
/// (can be
...
/// @param[in] attrib  map containing table of vertex attribute strings add
/// their
///            correspondingly ids (generated previously using
