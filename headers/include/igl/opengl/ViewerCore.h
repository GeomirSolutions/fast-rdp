...
class ViewerCore
{
  public:
    ...
    /// @param[in] data  which ViewerData to draw
    /// @param[in] update_matrices  whether to update view, proj, and norm
    IGL_INLINE void draw_shadow_pass(ViewerData &data,
                                     bool update_matrices = true);
    /// Render given ViewerData to a buffer. The width and height are determined
    /// by non-zeros dimensions of R (and G,B,A should match) or – if both are
    /// zero — are set to this core's viewport sizes.
    ///
    /// @param[in] data  which ViewerData to draw
    /// @param[in] update_matrices  whether to update view, proj, and norm
    /// matrices in
    ...
    IGL_INLINE void draw_labels(ViewerData &data,
...
inline void serialization(bool s, igl::opengl::ViewerCore &obj,
...
template <>
inline void serialize(const igl::opengl::ViewerCore &obj,
                      std::vector<char> &buffer)
{
...
template <>
inline void deserialize(igl::opengl::ViewerCore &obj,
