...
class MeshGL
{
  public:
    ...
    struct TextGL
    {
        ...
        Eigen::Matrix<unsigned, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
            label_indices_vbo;
        void init_buffers();
        void free_buffers();
    };
    ...
    /// Bind the underlying OpenGL buffer objects for subsequent line overlay
    /// draw calls
    ...
    /// Bind the underlying OpenGL buffer objects for subsequent point overlay
    /// draw calls
