    ...
    Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> &D)
{
    ...
    typedef typename std::conditional<std::is_floating_point<T>::value, GLfloat,
                                      GLubyte>::type GLType;
    GLenum type =
...
template void igl::opengl::read_pixels<unsigned char>(
    ...
    Eigen::Matrix<unsigned char, -1, -1, 0, -1, -1> &);
template void
igl::opengl::read_pixels<double>(unsigned int, unsigned int,
                                 ...
                                 Eigen::Matrix<double, -1, -1, 0, -1, -1> &);
template void
igl::opengl::read_pixels<float>(unsigned int, unsigned int,
