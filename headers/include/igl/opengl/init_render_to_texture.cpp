...
IGL_INLINE void
igl::opengl::init_render_to_texture(const size_t width, const size_t height,
                                    const bool depth_texture, GLuint &tex_id,
                                    GLuint &fbo_id, GLuint &d_id)
{
    using namespace std;
...
IGL_INLINE void igl::opengl::init_render_to_texture(const size_t width,
                                                    ...
                                                    GLuint &dfbo_id)
{
    return init_render_to_texture(width, height, false, tex_id, fbo_id,
                                  dfbo_id);
}
