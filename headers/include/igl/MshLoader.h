...
class MshLoader
{
  ...
  public:
    ...
    const StructIndex &get_structure_index() const { return m_structure_index; }
    ...
    const StructVector &get_structures() const { return m_structures; }
  ...
  private:
    ...
    StructIndex
        m_structure_length; // length of structures with consistent element type
};
