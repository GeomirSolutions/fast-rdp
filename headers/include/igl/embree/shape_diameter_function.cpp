...
IGL_INLINE void
igl::embree::shape_diameter_function(const igl::embree::EmbreeIntersector &ei,
                                     const Eigen::PlainObjectBase<DerivedP> &P,
                                     const Eigen::PlainObjectBase<DerivedN> &N,
                                     const int num_samples,
                                     Eigen::PlainObjectBase<DerivedS> &S)
{
    const auto &shoot_ray = [&ei](const Eigen::Vector3f &s,
...
IGL_INLINE void
igl::embree::shape_diameter_function(const Eigen::PlainObjectBase<DerivedV> &V,
...
template void
igl::embree::shape_diameter_function<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void
igl::embree::shape_diameter_function<Eigen::Matrix<double, 1, 3, 1, 1, 3>,
...
igl::embree::shape_diameter_function<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    int, Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void
igl::embree::shape_diameter_function<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
