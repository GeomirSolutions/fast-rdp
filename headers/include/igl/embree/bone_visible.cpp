    ...
    parallel_for(
        ...
        [&](const int v) {
            ...
            if (sd_norm < DOUBLE_EPS) {
                ...
                project_to_line(Vv(0), Vv(1), Vv(2), s(0), s(1), s(2), d(0),
                                d(1), d(2), projv(0), projv(1), projv(2), t,
                                sqrd);
            ...
            igl::Hit hit;
            // perhaps 1.0 should be 1.0-epsilon, or actually since we checking
            // the incident face, perhaps 1.0 should be 1.0+eps
