...
IGL_INLINE void igl::hausdorff(const Eigen::MatrixBase<DerivedVA> &VA,
...
template void igl::hausdorff<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::hausdorff<Eigen::Matrix<double, -1, -1, 0, -1, -1>, double>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    std::function<double(double const &, double const &, double const &)> const
        &,
    double &, double &);
#endif
