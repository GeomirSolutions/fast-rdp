                           ...
                           Eigen::PlainObjectBase<DerivedB> &B)
{
    const int m = X.size();
    using namespace std;
    assert((E.bottomRightCorner(E.size() - 1, 1) -
...
template void igl::histc<Eigen::Matrix<double, -1, 1, 0, -1, 1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::histc<Eigen::Matrix<float, -1, 1, 0, -1, 1>,
...
#else
template void
igl::histc<Eigen::CwiseNullaryOp<Eigen::internal::linspaced_op<int, true>,
                                 Eigen::Matrix<int, -1, 1, 0, -1, 1>>,
           Eigen::Matrix<int, -1, 1, 0, -1, 1>,
           Eigen::Matrix<int, -1, 1, 0, -1, 1>,
           Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<
        Eigen::CwiseNullaryOp<Eigen::internal::linspaced_op<int, true>,
