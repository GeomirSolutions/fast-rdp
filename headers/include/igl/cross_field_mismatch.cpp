...
class MismatchCalculator
{
  ...
  private:
    ...
    inline int mismatchByCross(const int f0, const int f1)
    {
  ...
  public:
    ...
    inline void
    calculateMismatch(Eigen::PlainObjectBase<DerivedM> &Handle_MMatch)
    {
...
template <typename DerivedV, typename DerivedF, typename DerivedM>
IGL_INLINE void igl::cross_field_mismatch(
    ...
    Eigen::PlainObjectBase<DerivedM> &mismatch)
{
    ...
    igl::MismatchCalculator<DerivedV, DerivedF, DerivedM> sf(V, F, PD1_combed,
                                                             PD2_combed);
...
template void igl::cross_field_mismatch<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
                                        Eigen::Matrix<int, -1, 3, 0, -1, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
    const bool, Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> &);
template void
igl::cross_field_mismatch<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
