...
/// @param[in] S  #point-handles+#region-handles list of lists of selected
/// vertices for
...
/// @param[out] W  #V by #points-handles+(#region-handles * dim+1) matrix of
/// weights so
...
template <typename DerivedV, typename DerivedT, typename SType,
          typename DerivedW>
IGL_INLINE bool biharmonic_coordinates(const Eigen::MatrixBase<DerivedV> &V,
