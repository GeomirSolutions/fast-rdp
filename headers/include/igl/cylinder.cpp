                              ...
                              Eigen::PlainObjectBase<DerivedF> &F)
{
    ...
    for (int th = 0; th < axis_devisions; th++) {
        ...
        for (int h = 0; h < height_devisions; h++) {
            ...
            if (h > 0) {
                F(f, 0) =
                    ((th + 0) % axis_devisions) + (h - 1) * axis_devisions;
                F(f, 1) =
                    ((th + 1) % axis_devisions) + (h - 1) * axis_devisions;
                F(f, 2) =
                    ((th + 0) % axis_devisions) + (h + 0) * axis_devisions;
                f++;
                F(f, 0) =
                    ((th + 1) % axis_devisions) + (h - 1) * axis_devisions;
                F(f, 1) =
                    ((th + 1) % axis_devisions) + (h + 0) * axis_devisions;
                F(f, 2) =
                    ((th + 0) % axis_devisions) + (h + 0) * axis_devisions;
                f++;
            }
...
template void igl::cylinder<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
