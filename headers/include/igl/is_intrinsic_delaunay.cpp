...
IGL_INLINE void igl::is_intrinsic_delaunay(const Eigen::MatrixBase<Derivedl> &l,
...
template <typename Derivedl, typename DerivedF, typename uE2EType,
          typename DerivedD>
IGL_INLINE void
igl::is_intrinsic_delaunay(const Eigen::MatrixBase<Derivedl> &l,
                           const Eigen::MatrixBase<DerivedF> &F,
                           ...
                           const Index num_faces, const Index uei)
{
    ...
    const auto cot_alpha = [](const Scalar &a, const Scalar &b,
...
template bool
igl::is_intrinsic_delaunay<Eigen::Matrix<double, -1, 3, 0, -1, 3>, int, int>(
...
// generated by autoexplicit.sh
template bool
igl::is_intrinsic_delaunay<Eigen::Matrix<double, -1, -1, 0, -1, -1>, int, int>(
...
// generated by autoexplicit.sh
template void
igl::is_intrinsic_delaunay<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
