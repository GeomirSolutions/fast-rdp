...
/// @param[in] GV  nx*ny*nz by 3 array of corresponding grid corner vertex
/// locations
...
///
template <typename DerivedS, typename DerivedGV, typename DerivedV,
          typename DerivedF>
IGL_INLINE void marching_cubes(const Eigen::MatrixBase<DerivedS> &S,
...
template <typename DerivedS, typename DerivedGV, typename DerivedGI,
