...
/// @param[out] BC  #U by #V sparse matrix of barycentric coordinates so that U
/// = BC*V
/// @param[out] L  #G list of bools whether scalar field in triangle below or
/// above val
...
template <typename DerivedF, typename DerivedS, typename DerivedG,
          ...
          typename DerivedL>
IGL_INLINE void remesh_along_isoline(
    const int n, const Eigen::MatrixBase<DerivedF> &F,
    const Eigen::MatrixBase<DerivedS> &S, const typename DerivedS::Scalar val,
