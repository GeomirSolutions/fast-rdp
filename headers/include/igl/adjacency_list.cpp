...
IGL_INLINE void igl::adjacency_list(const Eigen::MatrixBase<Index> &F,
                                    ...
                                    bool sorted)
{
    ...
    if (sorted) {
        ...
        // for every vertex v store a set of ordered edges not incident to v
        // that belongs to triangle incident on v.
...
template void igl::adjacency_list<Eigen::Matrix<int, -1, 2, 0, -1, 2>, int>(
...
template void igl::adjacency_list<Eigen::Matrix<int, -1, 3, 0, -1, 3>, int>(
    ...
    bool);
template void
igl::adjacency_list<class Eigen::Matrix<int, -1, -1, 0, -1, -1>, unsigned int>(
    ...
    class std::vector<
        ...
        class std::allocator<class std::vector<
            unsigned int, class std::allocator<unsigned int>>>> &,
    bool);
template void igl::adjacency_list<int>(
    std::vector<std::vector<int, std::allocator<int>>,
