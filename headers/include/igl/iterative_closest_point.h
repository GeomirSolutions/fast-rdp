...
/// @param[in] num_samples  number of random samples to use (larger --> more
/// accurate,
...
IGL_INLINE void iterative_closest_point(const Eigen::MatrixBase<DerivedVX> &VX,
...
/// \overload
/// @param[in] Ytree  precomputed AABB tree for accelerating closest point
/// queries
