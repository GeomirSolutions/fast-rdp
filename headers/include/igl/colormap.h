...
//
// Copyright (C) 2017 Joe Graus <jgraus@gmu.edu>, Alec Jacobson
...
/// @param[in] x_in  factor determining color value as if 0 was min and 1 was
/// max
/// @param[out] r  red value
/// @param[out] g  green value
/// @param[out] b  blue value
template <typename T>
IGL_INLINE void colormap(const double palette[256][3], const T x_in, T &r, T &g,
                         T &b);
/// Compute [r,g,b] values of the colormap palette for
...
IGL_INLINE void
colormap(const ColorMapType cm, const Eigen::MatrixBase<DerivedZ> &Z,
...
///  @param[out] C  #C by 3 list of rgb colors
template <typename DerivedZ, typename DerivedC>
IGL_INLINE void colormap(const ColorMapType cm,
