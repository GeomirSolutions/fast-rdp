                              ...
                              const Eigen::MatrixBase<DerivedC> &C)
{
    ...
    if (V.rows() != C.rows()) {
        fprintf(stderr, "IOError: writeOFF() Only color per vertex supported. "
                        "V and C should have same size.\n");
        return false;
    }
    ...
    Eigen::Matrix<typename DerivedC::Scalar, Eigen::Dynamic, Eigen::Dynamic>
        RGB_Array = rgbScale * C;
...
// generated by autoexplicit.sh
template bool igl::writeOFF<Eigen::Matrix<double, 8, 3, 0, 8, 3>,
