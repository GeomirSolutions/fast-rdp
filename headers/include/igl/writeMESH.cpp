                               ...
                               const Eigen::MatrixBase<DerivedF> &F)
{
    ...
    for (int i = 0; i < number_of_tetrahedra; i++) {
        ...
        fprintf(mesh_file, "%d %d %d %d 1\n", (int)T(i, 0) + 1,
                (int)T(i, 1) + 1, (int)T(i, 2) + 1, (int)T(i, 3) + 1);
    }
    fclose(mesh_file);
    return true;
}
...
template bool igl::writeMESH<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
...
// generated by autoexplicit.sh
template bool igl::writeMESH<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
                             Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                             Eigen::Matrix<int, -1, 3, 1, -1, 3>>(
    std::basic_string<char, std::char_traits<char>, std::allocator<char>>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &);
// generated by autoexplicit.sh
template bool igl::writeMESH<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
                             Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
// generated by autoexplicit.sh
template bool igl::writeMESH<Eigen::Matrix<double, 8, 3, 0, 8, 3>,
                             Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
template bool igl::writeMESH<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &);
template bool igl::writeMESH<double, int>(
    std::basic_string<char, std::char_traits<char>, std::allocator<char>>,
    std::vector<
