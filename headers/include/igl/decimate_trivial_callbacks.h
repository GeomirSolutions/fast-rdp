...
///
/// @param[out] always_try  function that always returns true (always attempt
/// the next
///               edge collapse)
/// @param[out] never_care  fuction that is always a no-op (never have a post
/// collapse
///     response)
IGL_INLINE void
decimate_trivial_callbacks(decimate_pre_collapse_callback &always_try,
