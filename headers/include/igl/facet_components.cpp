...
IGL_INLINE int igl::facet_components(const Eigen::MatrixBase<DerivedF> &F,
...
template void igl::facet_components<long, Eigen::Matrix<long, -1, 1, 0, -1, 1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<long, -1, 1, 0, -1, 1>> &);
template void igl::facet_components<int, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template int igl::facet_components<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                   Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
#ifdef WIN32
template void
igl::facet_components<__int64, class Eigen::Matrix<__int64, -1, 1, 0, -1, 1>,
