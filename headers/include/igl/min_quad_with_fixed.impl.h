    ...
    min_quad_with_fixed_data<T> &data)
{
    ...
    if (data.Auu_pd) {
        ...
        data.Auu_sym = true;
        // This is an annoying assertion unless EPS can be chosen in a nicer
        // way.
                               ...
                               Eigen::PlainObjectBase<Derivedsol> &sol)
{
    ...
    if (data.Aeq_li) {
        ...
        eff_Beq =
            // data.AeqTQR.colsPermutation().transpose() * (-data.Aeqk * Y +
            // Beq);
            data.AeqTET *
        ...
        MatrixXT NB;
        NB = -0.5 *
             (Bu.replicate(1, B.cols() == cols ? 1 : cols) + data.preY * Y);
        // Trim eff_Beq
        ...
        sol.block(solu.rows(), 0, solLambda.rows(), solLambda.cols()) =
            solLambda;
...
igl::min_quad_with_fixed_solve(const min_quad_with_fixed_data<T> &data,
                               ...
                               Eigen::PlainObjectBase<DerivedZ> &Z)
{
    Eigen::Matrix<typename DerivedZ::Scalar, Eigen::Dynamic, Eigen::Dynamic>
        sol;
...
IGL_INLINE Eigen::Matrix<Scalar, n, 1> igl::min_quad_with_fixed(
    const Eigen::Matrix<Scalar, n, n> &H, const Eigen::Matrix<Scalar, n, 1> &f,
    const Eigen::Array<bool, n, 1> &k, const Eigen::Matrix<Scalar, n, 1> &bc,
    const Eigen::Matrix<Scalar, m, n> &A, const Eigen::Matrix<Scalar, m, 1> &b)
{
    ...
    const Eigen::Array<bool, n, 1> &k, const Eigen::Matrix<Scalar, n, 1> &bc)
{
    ...
    if (kcount == 0) {
        ...
        typedef typename std::conditional<
            Hpd, Eigen::LLT<MatrixSn>,
            Eigen::CompleteOrthogonalDecomposition<MatrixSn>>::type Solver;
    ...
    // dispatching to the appropriate templated function when the argument
    // matches (with a fallback to the dynamic version). Cf this example:
    ...
    // (n-%d<=0)||(%d>=n)||(n>%d);\n     return
    // min_quad_with_fixed<Scalar,D?Eigen::Dynamic:n,D?Eigen::Dynamic:%d,Hpd>(H,f,k,bc);\n
    // }\n',[i i i maxi i]);end
    case 1: {
        const bool D = (n - 1 <= 0) || (1 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 1, Hpd > (H, f, k, bc);
    }
    case 2: {
        const bool D = (n - 2 <= 0) || (2 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 2, Hpd > (H, f, k, bc);
    }
    case 3: {
        const bool D = (n - 3 <= 0) || (3 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 3, Hpd > (H, f, k, bc);
    }
    case 4: {
        const bool D = (n - 4 <= 0) || (4 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 4, Hpd > (H, f, k, bc);
    }
    case 5: {
        const bool D = (n - 5 <= 0) || (5 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 5, Hpd > (H, f, k, bc);
    }
    case 6: {
        const bool D = (n - 6 <= 0) || (6 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 6, Hpd > (H, f, k, bc);
    }
    case 7: {
        const bool D = (n - 7 <= 0) || (7 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 7, Hpd > (H, f, k, bc);
    }
    case 8: {
        const bool D = (n - 8 <= 0) || (8 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 8, Hpd > (H, f, k, bc);
    }
    case 9: {
        const bool D = (n - 9 <= 0) || (9 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 9, Hpd > (H, f, k, bc);
    }
    case 10: {
        const bool D = (n - 10 <= 0) || (10 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 10, Hpd > (H, f, k, bc);
    }
    case 11: {
        const bool D = (n - 11 <= 0) || (11 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 11, Hpd > (H, f, k, bc);
    }
    case 12: {
        const bool D = (n - 12 <= 0) || (12 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 12, Hpd > (H, f, k, bc);
    }
    case 13: {
        const bool D = (n - 13 <= 0) || (13 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 13, Hpd > (H, f, k, bc);
    }
    case 14: {
        const bool D = (n - 14 <= 0) || (14 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 14, Hpd > (H, f, k, bc);
    }
    case 15: {
        const bool D = (n - 15 <= 0) || (15 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 15, Hpd > (H, f, k, bc);
    }
    case 16: {
        const bool D = (n - 16 <= 0) || (16 >= n) || (n > 16);
        return min_quad_with_fixed < Scalar, D ? Eigen::Dynamic : n,
               D ? Eigen::Dynamic : 16, Hpd > (H, f, k, bc);
    }
    default:
        return min_quad_with_fixed<Scalar, Eigen::Dynamic, Eigen::Dynamic, Hpd>(
            H, f, k, bc);
    }
}
    ...
    const Eigen::Array<bool, n, 1> &k, const Eigen::Matrix<Scalar, n, 1> &bc)
{
    ...
    const auto dyn_ucount =
        ucount == Eigen::Dynamic ? dyn_n - dyn_kcount : ucount;
    ...
    typedef typename std::conditional<
        ...
        // template" parameters did work because LLT,LDLT have different number
        // of template parameters from CompleteOrthogonalDecomposition.  Perhaps
        // there's a way to take advantage of LLT and LDLT's default template
        // parameters (I couldn't figure out how).
        Eigen::CompleteOrthogonalDecomposition<MatrixSuu>>::type Solver;
