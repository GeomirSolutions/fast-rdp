...
/// @param[out] d a column vector with r entries that contains the dot product
/// of each corresponding row of A and B
///
...
IGL_INLINE DerivedV dot_row(const Eigen::PlainObjectBase<DerivedV> &A,
