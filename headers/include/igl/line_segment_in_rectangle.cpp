                                               ...
                                               const Eigen::Vector2d &B)
{
    ...
    const auto SegmentIntersectRectangle =
        [](double a_rectangleMinX, double a_rectangleMinY,
           double a_rectangleMaxX, double a_rectangleMaxY, double a_p1x,
           double a_p1y, double a_p2x, double a_p2y) -> bool {
    ...
    bool ret = SegmentIntersectRectangle(minX, minY, maxX, maxY, s(0), s(1),
                                         d(0), d(1));
    return ret;
}
