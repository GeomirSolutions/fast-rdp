...
///
/// @param[in] win  #P by 3 or 3-vector (#P=1) of screen space x, y, and z
/// coordinates
/// @param[in] model  4x4 model-view matrix
/// @param[in] proj  4x4 projection matrix
/// @param[in] viewport  4-long viewport vector
/// @param[out] scene  #P by 3 or 3-vector (#P=1) the unprojected x, y, and z
/// coordinates
///
...
IGL_INLINE void unproject(const Eigen::MatrixBase<Derivedwin> &win,
