...
IGL_INLINE void igl::barycentric_coordinates(
    const Eigen::MatrixBase<DerivedP> &P, const Eigen::MatrixBase<DerivedA> &A,
    const Eigen::MatrixBase<DerivedB> &B, const Eigen::MatrixBase<DerivedC> &C,
    const Eigen::MatrixBase<DerivedD> &D, Eigen::PlainObjectBase<DerivedL> &L)
{
    ...
    assert(P.rows() == A.rows() &&
           "Must have same number of queries as corners");
    ...
    Eigen::PlainObjectBase<DerivedL> &L)
{
    ...
    typedef Eigen::Array<typename DerivedP::Scalar, DerivedP::RowsAtCompileTime,
...
template void igl::barycentric_coordinates<
