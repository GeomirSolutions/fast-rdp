...
IGL_INLINE void igl::procrustes(const Eigen::MatrixBase<DerivedX> &X,
                                const Eigen::MatrixBase<DerivedY> &Y,
                                const bool includeScaling,
                                const bool includeReflections, Scalar &scale,
                                ...
                                Eigen::PlainObjectBase<DerivedT> &t)
{
    ...
    // Center data
    const Matrix<typename DerivedX::Scalar, Dynamic, 1> Xmean =
        X.colwise().mean();
    const Matrix<typename DerivedY::Scalar, Dynamic, 1> Ymean =
        Y.colwise().mean();
...
template void igl::procrustes<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
                              Eigen::Matrix<double, -1, 3, 0, -1, 3>, double,
...
template void igl::procrustes<Eigen::Matrix<double, 3, 2, 0, 3, 2>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<double, 3, 2, 0, 3, 2>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 3, 2, 0, 3, 2>> const &, const bool,
    const bool, double &,
