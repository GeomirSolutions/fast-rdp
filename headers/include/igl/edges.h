...
IGL_INLINE void edges(const Eigen::MatrixBase<DerivedF> &F,
...
IGL_INLINE void edges(const Eigen::MatrixBase<DerivedI> &I,
...
IGL_INLINE void edges(const Eigen::SparseMatrix<T> &A,
                      Eigen::PlainObjectBase<DerivedE> &E);
} // namespace igl
