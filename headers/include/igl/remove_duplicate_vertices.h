...
/// @param[in] epsilon  uniqueness tolerance used coordinate-wise: 1e0 -->
/// integer
...
template <typename DerivedV, typename DerivedSV, typename DerivedSVI,
          typename DerivedSVJ>
IGL_INLINE void
remove_duplicate_vertices(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void remove_duplicate_vertices(
    ...
    const double epsilon, Eigen::PlainObjectBase<DerivedSV> &SV,
    Eigen::PlainObjectBase<DerivedSVI> &SVI,
    Eigen::PlainObjectBase<DerivedSVJ> &SVJ,
