...
/// @param[in] r  Poisson disk radius (evaluated according to Euclidean distance
/// on V)
/// @param[out] B  #P by 3 list of barycentric coordinates, ith row are
/// coordinates of
...
template <typename DerivedV, typename DerivedF, typename DerivedB,
          typename DerivedFI, typename DerivedP, typename URBG = DEFAULT_URBG>
IGL_INLINE void blue_noise(const Eigen::MatrixBase<DerivedV> &V,
