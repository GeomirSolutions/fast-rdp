...
IGL_INLINE int igl::connected_components(const Eigen::SparseMatrix<Atype> &A,
                                         ...
                                         Eigen::PlainObjectBase<DerivedK> &K)
{
    ...
    for (Eigen::Index f = 0; f < m; f++) {
        ...
        while (!Q.empty()) {
            ...
            C(g) = c;
            K(c)++;
            for (typename Eigen::SparseMatrix<Atype>::InnerIterator it(A, g);
                 it; ++it) {
...
template int
igl::connected_components<bool, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                          Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::SparseMatrix<bool, 0, int> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
// generated by autoexplicit.sh
template int igl::connected_components<int, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                                       Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
