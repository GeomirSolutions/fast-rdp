...
/// @param[in] uEC  #uE+1 list of cumsums of directed edges sharing each unique
/// edge
...
IGL_INLINE size_t
extract_manifold_patches(const Eigen::MatrixBase<DerivedF> &F,
...
IGL_INLINE size_t extract_manifold_patches(const Eigen::MatrixBase<DerivedF> &F,
                                           Eigen::PlainObjectBase<DerivedP> &P);
} // namespace igl
