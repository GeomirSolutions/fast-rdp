...
IGL_INLINE void
igl::per_vertex_normals(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void igl::per_vertex_normals(const Eigen::MatrixBase<DerivedV> &V,
                                        ...
                                        Eigen::PlainObjectBase<DerivedN> &N)
{
    return per_vertex_normals(V, F, PER_VERTEX_NORMALS_WEIGHTING_TYPE_DEFAULT,
                              N);
}
    ...
    const Eigen::MatrixBase<DerivedFN> &FN, Eigen::PlainObjectBase<DerivedN> &N)
{
    ...
    Eigen::Matrix<typename DerivedN::Scalar, DerivedF::RowsAtCompileTime, 3> W(
        F.rows(), 3);
    switch (weighting) {
    ...
    case PER_VERTEX_NORMALS_WEIGHTING_TYPE_AREA: {
        Eigen::Matrix<typename DerivedN::Scalar, DerivedF::RowsAtCompileTime, 1>
            A;
        doublearea(V, F, A);
        W = A.replicate(1, 3);
        break;
...
template void
igl::per_vertex_normals<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
...
// generated by autoexplicit.sh
template void igl::per_vertex_normals<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
...
// generated by autoexplicit.sh
template void igl::per_vertex_normals<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
                                      Eigen::Matrix<int, -1, 3, 0, -1, 3>,
                                      Eigen::Matrix<float, -1, -1, 0, -1, -1>,
                                      Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void igl::per_vertex_normals<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
                                      Eigen::Matrix<int, -1, 3, 1, -1, 3>,
