...
/// matrix.
///
/// Outputs a component ID per vertex of the graph where connectivity is
/// established by edges.
///
...
IGL_INLINE void
vertex_components(const Eigen::SparseCompressedBase<DerivedA> &A,
...
/// Returns a component ID per vertex of the mesh where connectivity is
/// established by edges.
///
...
IGL_INLINE void vertex_components(const Eigen::MatrixBase<DerivedF> &F,
                                  Eigen::PlainObjectBase<DerivedC> &C);
