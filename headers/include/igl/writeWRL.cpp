...
ccw TRUE
      ...
      << FF.format(IOFormat(FullPrecision, DontAlignCols, ",", "\n", "", "",
                            "coordIndex [ \n", " ]\n"))
      << RGB.format(IOFormat(FullPrecision, DontAlignCols, ",", "\n", "", "",
                             "colorPerVertex TRUE\ncolor Color { color [ \n",
                             " ] }\n"))
      << "}\n}\n]\n}\n";
    return true;
...
template bool igl::writeWRL<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
...
// generated by autoexplicit.sh
template bool igl::writeWRL<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
                            Eigen::Matrix<int, -1, 3, 1, -1, 3>>(
    std::basic_string<char, std::char_traits<char>, std::allocator<char>> const
        &,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &);
// generated by autoexplicit.sh
template bool igl::writeWRL<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
// generated by autoexplicit.sh
template bool igl::writeWRL<Eigen::Matrix<double, 8, 3, 0, 8, 3>,
