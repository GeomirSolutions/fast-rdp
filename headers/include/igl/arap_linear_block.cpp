...
IGL_INLINE void
igl::arap_linear_block(const MatV &V, const MatF &F, const int d,
                       const igl::ARAPEnergyType energy, MatK &Kd)
{
    switch (energy) {
...
template <typename MatV, typename MatF, typename MatK>
IGL_INLINE void igl::arap_linear_block_elements(const MatV &V, const MatF &F,
                                                const int d, MatK &Kd)
{
    typedef typename MatK::Scalar Scalar;
    using namespace std;
...
template void igl::arap_linear_block<
...
template void igl::arap_linear_block<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
