                                     ...
                                     Eigen::PlainObjectBase<DerivedK> &K)
{
    ...
    K.resizeLike(F);
    auto corner = [](const typename DerivedV::ConstRowXpr &x,
                     const typename DerivedV::ConstRowXpr &y,
                     const typename DerivedV::ConstRowXpr &z) {
        auto v1 = x - y;
        auto v2 = z - y;
        return Scalar(2) * atan((v1 / v1.norm() - v2 / v2.norm()).norm() /
...
template void igl::internal_angles<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
                                   Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                   Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> &);
template void igl::internal_angles<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
...
template void igl::internal_angles<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
...
template void igl::internal_angles<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> &);
template void igl::internal_angles<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
                                   Eigen::Matrix<int, -1, 3, 1, -1, 3>,
                                   Eigen::Matrix<double, -1, 3, 0, -1, 3>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 1, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &,
