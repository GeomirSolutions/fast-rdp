    ...
    Eigen::PlainObjectBase<DerivedCN> &CN)
{
    ...
    igl::parallel_for(
        F.rows(),
        [&](const Index f) {
            const Eigen::Matrix<Scalar, 1, 3> v10 =
                V.row(F(f, 1)) - V.row(F(f, 0));
            const Eigen::Matrix<Scalar, 1, 3> v20 =
                V.row(F(f, 2)) - V.row(F(f, 0));
...
IGL_INLINE void igl::per_corner_normals(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void igl::per_corner_normals(const Eigen::MatrixBase<DerivedNV> &NV,
...
template void igl::per_corner_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::Matrix<double, -1, -1, 0, -1, -1>::Scalar,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> &);
template void igl::per_corner_normals<
    Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
// template void igl::per_corner_normals<Eigen::Matrix<double, -1, -1, 0, -1,
// -1>, Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<double, -1, -1, 0,
// -1, -1> >(Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1> >
// const&, Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1> > const&,
// Eigen::Matrix<double, -1, -1, 0, -1, -1>::Scalar,
// Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1> >&);
template void igl::per_corner_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                                      Eigen::Matrix<int, -1, -1, 0, -1, -1>,
