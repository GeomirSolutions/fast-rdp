...
{
    stopping_condition =
        [orig_m, max_m, &m](const Eigen::MatrixXd &, const Eigen::MatrixXi &,
                            ...
                            const int, const int, const int, const int f1,
                            const int f2) -> bool {
...
igl::max_faces_stopping_condition(int &m, const int orig_m, const int max_m)
{
    decimate_stopping_condition_callback stopping_condition;
