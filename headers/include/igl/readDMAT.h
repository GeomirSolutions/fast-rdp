...
/// ASCII or binary data. Note that it is uncompressed so binary only reduces
/// the file size by 50%. But writing and reading binary is usually faster. In
/// MATLAB, binary is almost 100x faster.
///
/// ASCII
/// -----
///
