...
IGL_INLINE void igl::min(const Eigen::SparseMatrix<AType> &A, const int dim,
                         ...
                         Eigen::PlainObjectBase<DerivedI> &I)
{
    ...
    I.resize(dim == 1 ? n : m);
    for_each(A,
             [&B, &I, &dim](int i, int j, const typename DerivedB::Scalar v) {
                 if (dim == 2) {
                     std::swap(i, j);
                 }
...
IGL_INLINE void igl::min(const Eigen::DenseBase<DerivedX> &X, const int dim,
...
template void igl::min<Eigen::Array<bool, -1, 3, 0, -1, 3>,
                       Eigen::Array<bool, -1, 1, 0, -1, 1>,
                       Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::DenseBase<Eigen::Array<bool, -1, 3, 0, -1, 3>> const &, int,
    Eigen::PlainObjectBase<Eigen::Array<bool, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::min<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
