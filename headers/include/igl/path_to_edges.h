...
namespace igl
{
/// Given a path as an ordered list of N>=2 vertex indices I[0], I[1], ...,
/// I[N-1] construct a list of edges [[I[0],I[1]], [I[1],I[2]], ..., [I[N-2],
/// I[N-1]]] connecting each sequential pair of vertices.
///
...
IGL_INLINE void path_to_edges(const Eigen::MatrixBase<DerivedI> &I,
                              Eigen::PlainObjectBase<DerivedE> &E,
                              bool make_loop = false);
/// \overload
template <typename Index, typename DerivedE>
IGL_INLINE void path_to_edges(const std::vector<Index> &I,
                              Eigen::PlainObjectBase<DerivedE> &E,
                              bool make_loop = false);
} // namespace igl
