...
IGL_INLINE void igl::boundary_loop(const Eigen::MatrixBase<DerivedF> &F,
                                   std::vector<std::vector<Index>> &L)
{
    ...
    Eigen::Matrix<typename DerivedF::Scalar, Eigen::Dynamic, Eigen::Dynamic> TT,
        TTi;
...
template void igl::boundary_loop<Eigen::Matrix<int, -1, -1, 0, -1, -1>, int>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
