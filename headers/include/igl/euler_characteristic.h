...
///
/// \note There is [some
/// confusion](https://github.com/libigl/libigl/issues/2249#issue-1863608449)
/// over the standard definition of Euler characteristic. libigl's definition
/// agrees with [wikipedia](https://en.wikipedia.org/wiki/Euler_characteristic)
/// and [David Eppstein's
