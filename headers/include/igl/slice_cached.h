...
/// @param[out] data Temporary data used by slice_cached to repeat this
/// operation
...
IGL_INLINE void
slice_cached_precompute(const Eigen::SparseMatrix<TX> &X,
...
/// @param[out] Y  #R by #C matrix
template <typename TX, typename TY, typename DerivedI>
IGL_INLINE void slice_cached(const Eigen::SparseMatrix<TX> &X,
