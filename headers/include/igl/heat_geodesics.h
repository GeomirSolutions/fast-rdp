...
///
/// \fileinfo
template <typename Scalar> struct HeatGeodesicsData
{
    /// Gradient operator
...
IGL_INLINE bool heat_geodesics_precompute(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void
heat_geodesics_solve(const HeatGeodesicsData<Scalar> &data,
