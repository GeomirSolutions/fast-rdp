...
/// list of
///
/// @param[in] E  #E by simplex_size-1  list of exterior edges (see
/// exterior_edges.h)
/// @param[out] cap  #cap by simplex_size  list of "faces" tessellating the
/// boundary edges
template <typename DerivedE, typename Derivedcap>
IGL_INLINE void triangle_fan(const Eigen::MatrixBase<DerivedE> &E,
