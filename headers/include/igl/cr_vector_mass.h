...
template <typename DerivedV, typename DerivedF, typename DerivedE,
          typename ScalarM>
IGL_INLINE void cr_vector_mass(const Eigen::MatrixBase<DerivedV> &V,
...
///
///  \fileinfo
template <typename DerivedF, typename DeriveddA, typename DerivedE,
          typename ScalarM>
IGL_INLINE void cr_vector_mass_intrinsic(const Eigen::MatrixBase<DerivedF> &F,
