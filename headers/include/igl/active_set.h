...
/// @param[in] Bieq  mieq by 1 list of linear inequality constraint constant
/// values
...
/// @param[in,out] Z  if not empty, is taken to be an n by 1 list of initial
/// guess values. Set to solution on output.
...
struct igl::active_set_params
{
    ...
    int max_iter;
    ///  inactive_threshold  Threshold on Lagrange multiplier values to
    ///  determine
    ...
    ///  solution_diff_threshold  Threshold on the squared norm of the
    ///  difference
