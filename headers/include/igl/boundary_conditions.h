...
/// @param[out] b  #b list of boundary indices (indices into V of vertices which
/// have
///     known, fixed values)
/// @param[out] bc #b by #weights list of known/fixed values for boundary
/// vertices
...
boundary_conditions(const Eigen::MatrixXd &V, const Eigen::MatrixXi &Ele,
                    ...
                    const Eigen::MatrixXi &CF, Eigen::VectorXi &b,
                    Eigen::MatrixXd &bc);
} // namespace igl
