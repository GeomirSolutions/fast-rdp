...
/// @param[out] SF  #F by 3 list of mesh triangle indices into rows of a new
/// vertex list
///               SV = V(SVI,:)
...
IGL_INLINE void split_nonmanifold(const Eigen::MatrixBase<DerivedF> &F,
...
IGL_INLINE void split_nonmanifold(const Eigen::MatrixBase<DerivedV> &V,
