...
/// @param[out] VI  #V list of lists of index of incidence within incident faces
/// listed
///     in VF
///
...
/// @param[out] VF  3*#F list  List of faces indice on each vertex, so that
/// VF(NI(i)+j) =
...
IGL_INLINE void
vertex_triangle_adjacency(const Eigen::MatrixBase<DerivedF> &F, const int n,
