...
IGL_INLINE void
igl::internal_angles_intrinsic(const Eigen::MatrixBase<DerivedL> &L_sq,
    ...
    parallel_for(
        ...
        [&L_sq, &K](const Index f) {
            for (size_t d = 0; d < 3; d++) {
                ...
                K(f, d) = std::acos((s3 + s2 - s1) /
                                    (Scalar(2) * std::sqrt(s3 * s2)));
                ...
                // if(a<b){ std::swap(a,b); }
                //// Then perform two more comparisons to decide whether and how
                /// to / compute an intermediate quantity µ thus:
                // using Scalar = typename DerivedK::Scalar;
                // Scalar mu;
                // if(b>=c && c>=0)
                //{
...
template void
igl::internal_angles_intrinsic<Eigen::Matrix<float, -1, 1, 0, -1, 1>,
                               Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, -1, 1, 0, -1, 1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void
igl::internal_angles_intrinsic<Eigen::Matrix<double, -1, 1, 0, -1, 1>,
...
// generated by autoexplicit.sh
template void
igl::internal_angles_intrinsic<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
...
// generated by autoexplicit.sh
template void
igl::internal_angles_intrinsic<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
                               Eigen::Matrix<double, -1, 3, 0, -1, 3>>(
