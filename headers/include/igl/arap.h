...
IGL_INLINE bool
arap_precomputation(const Eigen::MatrixBase<DerivedV> &V,
...
/// Taking a reference to MatrixBase in this case thus allows the user to
/// provide e.g. a map to the position data, allowing seamless interoperability
/// with user-defined datastructures without requiring a copy.
template <typename Derivedbc, typename DerivedU>
IGL_INLINE bool arap_solve(const Eigen::MatrixBase<Derivedbc> &bc,
