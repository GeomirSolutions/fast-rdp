...
IGL_INLINE void igl::tetrahedralized_grid(const int nx, const int ny,
                                          const int nz,
...
IGL_INLINE void
igl::tetrahedralized_grid(const Eigen::MatrixBase<Derivedside> &side,
                          const TetrahedralizedGripType type,
                          Eigen::PlainObjectBase<DerivedGT> &GT)
{
    const int nx = side(0);
...
template void igl::tetrahedralized_grid<Eigen::Matrix<int, 1, 3, 1, 1, 3>,
                                        Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, 1, 3, 1, 1, 3>> const &,
    igl::TetrahedralizedGripType,
