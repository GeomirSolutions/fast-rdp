...
/// @param[out] X  #flipped list of containing the indices into F of the flipped
/// triangles
template <typename DerivedV, typename DerivedF, typename DerivedX>
IGL_INLINE void flipped_triangles(const Eigen::MatrixBase<DerivedV> &V,
                                  const Eigen::MatrixBase<DerivedF> &F,
                                  Eigen::PlainObjectBase<DerivedX> &X);
/// \overload
template <typename Scalar, typename Index>
IGL_INLINE Eigen::VectorXi flipped_triangles(const Eigen::MatrixBase<Scalar> &V,
