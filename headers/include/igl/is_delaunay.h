...
/// @param[out] D  #F by 3 list of bools revealing whether edges corresponding
/// 23 31 12
...
IGL_INLINE void is_delaunay(const Eigen::MatrixBase<DerivedV> &V,
                            const Eigen::MatrixBase<DerivedF> &F,
                            Eigen::PlainObjectBase<DerivedD> &D);
/// Determine whether a single edge is Delaunay using a provided (extrinsic)
/// incirle test.
///
/// @param[in] V  #V by dim list of vertex positions
/// @param[in] F  #F by 3 list of triangles indices
...
template <typename DerivedV, typename DerivedF, typename uE2EType,
          typename InCircle, typename ueiType>
IGL_INLINE bool is_delaunay(const Eigen::MatrixBase<DerivedV> &V,
                            const Eigen::MatrixBase<DerivedF> &F,
                            const std::vector<std::vector<uE2EType>> &uE2E,
                            const InCircle incircle, const ueiType uei);
