...
/// @param[out] B2 eigen matrix #F by 3, each vector is tangent to the triangle
/// and perpendicular to B1
/// @param[out] B3 eigen matrix #F by 3, normal of the triangle
///
template <typename DerivedV, typename DerivedF>
IGL_INLINE void local_basis(const Eigen::MatrixBase<DerivedV> &V,
