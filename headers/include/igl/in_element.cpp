...
IGL_INLINE void igl::in_element(const Eigen::MatrixBase<DerivedV> &V,
...
template void igl::in_element<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<double, -1, -1, 0, -1, -1>, 2>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::Matrix<int, -1, -1, 0, -1, -1> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    igl::AABB<Eigen::Matrix<double, -1, -1, 0, -1, -1>, 2> const &,
    Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
template void igl::in_element<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<double, -1, -1, 0, -1, -1>, 3>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::Matrix<int, -1, -1, 0, -1, -1> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
