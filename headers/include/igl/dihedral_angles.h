...
/// @param[out] cos_theta  #T by 6 list of cosine of dihedral angles (in
/// radians)
///
template <typename DerivedV, typename DerivedT, typename Derivedtheta,
          typename Derivedcos_theta>
IGL_INLINE void
dihedral_angles(const Eigen::MatrixBase<DerivedV> &V,
...
template <typename DerivedL, typename DerivedA, typename Derivedtheta,
          typename Derivedcos_theta>
IGL_INLINE void
dihedral_angles_intrinsic(const Eigen::MatrixBase<DerivedL> &L,
