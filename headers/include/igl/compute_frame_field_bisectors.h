...
/// @param[in] PD1   #F by 3 eigen Matrix of the first per face frame field
/// vector
/// @param[in] PD2   #F by 3 eigen Matrix of the second per face frame field
/// vector
/// @param[out] BIS1  #F by 3 eigen Matrix of the first per face frame field
/// bisector
/// @param[out] BIS2  #F by 3 eigen Matrix of the second per face frame field
/// bisector
///
...
IGL_INLINE void
compute_frame_field_bisectors(const Eigen::MatrixBase<DerivedV> &V,
