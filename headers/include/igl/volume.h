...
IGL_INLINE void volume(const Eigen::MatrixBase<DerivedV> &V,
...
IGL_INLINE void volume(const Eigen::MatrixBase<DerivedA> &A,
...
IGL_INLINE void volume(const Eigen::MatrixBase<DerivedL> &L,
                       Eigen::PlainObjectBase<Derivedvol> &vol);
} // namespace igl
