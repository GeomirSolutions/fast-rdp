...
template <typename DerivedV, typename DerivedF, typename Derivedb,
          typename Derivedbc, typename DerivedV_uv, typename QScalar>
...
/// \overload
template <typename DerivedV, typename DerivedF, typename Derivedb,
          typename Derivedbc, typename DerivedV_uv>
IGL_INLINE bool lscm(const Eigen::MatrixBase<DerivedV> &V,
                     const Eigen::MatrixBase<DerivedF> &F,
                     const Eigen::MatrixBase<Derivedb> &b,
                     const Eigen::MatrixBase<Derivedbc> &bc,
...
/// \overload
///
/// \brief Free boundary version. "Spectral Conformal Parameterization" using
