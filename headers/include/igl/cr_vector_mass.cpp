...
template <typename DerivedV, typename DerivedF, typename DerivedE,
          typename ScalarM>
IGL_INLINE void igl::cr_vector_mass(const Eigen::MatrixBase<DerivedV> &V,
...
template <typename DerivedF, typename DeriveddA, typename DerivedE,
          typename ScalarM>
IGL_INLINE void
igl::cr_vector_mass_intrinsic(const Eigen::MatrixBase<DerivedF> &F,
...
template void
igl::cr_vector_mass<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
