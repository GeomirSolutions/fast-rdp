...
IGL_INLINE void igl::edges(const Eigen::MatrixBase<DerivedI> &I,
...
IGL_INLINE void igl::edges(const Eigen::SparseMatrix<T> &A,
                           Eigen::PlainObjectBase<DerivedE> &E)
{
...
template void igl::edges<Eigen::Matrix<int, -1, 1, 0, -1, 1>,
...
template void igl::edges<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void igl::edges<Eigen::Matrix<int, -1, 3, 0, -1, 3>,
                         Eigen::Matrix<int, -1, 2, 0, -1, 2>>(
