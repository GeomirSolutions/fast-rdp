                                   ...
                                   Eigen::PlainObjectBase<DerivedLOCB> &LOCB)
{
    ...
    typedef Eigen::Matrix<typename DerivedA::Scalar,
                          ...
                          DerivedA::RowsAtCompileTime>
        MatrixA;
    typedef Eigen::Matrix<typename DerivedB::Scalar,
    ...
    // the templates on windows. Until we systematically template to support
    // int64 etc. we should assume the inputs don't exceed 2147483647, which is
    // reasonable.
    typedef int Index;
...
template void igl::ismember_rows<
    ...
    Eigen::PlainObjectBase<Eigen::Array<bool, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::ismember_rows<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::ismember_rows<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::ismember_rows<
    Eigen::Matrix<int, -1, 4, 0, -1, 4>, Eigen::Matrix<int, 12, 4, 0, 12, 4>,
    Eigen::Array<bool, -1, 1, 0, -1, 1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 4, 0, -1, 4>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, 12, 4, 0, 12, 4>> const &,
    Eigen::PlainObjectBase<Eigen::Array<bool, -1, 1, 0, -1, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
#endif
