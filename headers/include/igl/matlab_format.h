...
matlab_format(const Eigen::DenseBase<DerivedM> &M, const std::string name = "");
/// \overload
///
/// \brief Add +1 to every entry before formatting.
template <typename DerivedM>
IGL_INLINE std::string matlab_format_index(const Eigen::MatrixBase<DerivedM> &M,
...
/// \overload
/// \brief Scalars.
IGL_INLINE const std::string matlab_format(const double v,
                                           const std::string name = "");
/// \overload
IGL_INLINE const std::string matlab_format(const float v,
                                           const std::string name = "");
