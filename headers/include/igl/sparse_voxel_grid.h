...
namespace igl
{
/// Given a point, p0, on an isosurface, construct a shell of epsilon sized
/// cubes surrounding the surface. These cubes can be used as the input to
/// marching cubes.
///
/// @param[in] p0  A 3D point on the isosurface surface defined by scalarFunc(x)
/// = 0
/// @param[in] scalarFunc  A scalar function from R^3 to R -- points which map
/// to 0 lie
...
/// @param[in] expected_number_of_cubes  This pre-allocates internal data
...
/// @param[out] CI  #CI by 8 list of cube indices into rows of CS and CV. Each
/// row
