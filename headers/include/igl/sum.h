...
/// @tparam AType  should be a eigen sparse matrix primitive type like int or
/// double
/// @tparam DerivedB  should be a eigen dense matrix primitive type like int or
/// double
template <typename AType, typename DerivedB>
IGL_INLINE void sum(const Eigen::SparseMatrix<AType> &A, const int dim,
