                         ...
                         Eigen::PlainObjectBase<DerivedS> &S)
{
    ...
    const Scalar upper_bound = isolevel + sqrt(3.0) * h;
    {
        ...
        igl::signed_distance(GV, V, F, signed_distance_type, lower_bound,
                             upper_bound, S, I, C, N);
    }
...
template void igl::offset_surface<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::Matrix<int, 1, 3, 1, 1, 3>::Scalar, igl::SignedDistanceType const &,
...
template void igl::offset_surface<
    ...
    Eigen::Matrix<int, -1, 3, 1, -1, 3>,
    Eigen::Matrix<float, -1, -1, 0, -1, -1>, Eigen::Matrix<int, 1, 3, 1, 1, 3>,
    Eigen::Matrix<float, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, -1, 3, 1, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &, float,
    Eigen::Matrix<int, 1, 3, 1, 1, 3>::Scalar, igl::SignedDistanceType const &,
