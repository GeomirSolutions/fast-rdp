...
///
/// @tparam IndexVector  list of indices, value should be non-negative and
/// should
///     expect to be cast to an index. Must implement operator(i) to retrieve
///     ith element
/// @tparam ValueVector  list of values, value should be expect to be cast to
/// type
...
IGL_INLINE void sparse(const IndexVectorI &I, const IndexVectorJ &J,
