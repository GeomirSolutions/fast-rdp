...
IGL_INLINE bool
igl::writeSTL(const std::string &filename, const Eigen::MatrixBase<DerivedV> &V,
              const Eigen::MatrixBase<DerivedF> &F,
              const Eigen::MatrixBase<DerivedN> &N, FileEncoding encoding)
{
    using namespace std;
...
{
    return writeSTL(filename, V, F,
                    Eigen::Matrix<typename DerivedV::Scalar, Eigen::Dynamic,
                                  Eigen::Dynamic>(),
                    encoding);
}
...
template bool igl::writeSTL<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
    ...
    igl::FileEncoding);
// generated by autoexplicit.sh
template bool igl::writeSTL<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
    ...
    igl::FileEncoding);
// generated by autoexplicit.sh
template bool igl::writeSTL<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
                            Eigen::Matrix<int, -1, 3, 1, -1, 3>>(
    std::basic_string<char, std::char_traits<char>, std::allocator<char>> const
        &,
    ...
    igl::FileEncoding);
// generated by autoexplicit.sh
template bool igl::writeSTL<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
...
template bool igl::writeSTL<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    igl::FileEncoding);
template bool igl::writeSTL<Eigen::Matrix<double, 8, 3, 0, 8, 3>,
