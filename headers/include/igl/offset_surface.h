...
/// @param[out] S  #GV by 3 list of signed distance values _near_ `isolevel`
/// ("far"
///     from `isolevel` these values are incorrect)
///
template <typename DerivedV, typename DerivedF, typename isolevelType,
          typename DerivedSV, typename DerivedSF, typename DerivedGV,
          typename Derivedside, typename DerivedS>
void offset_surface(const Eigen::MatrixBase<DerivedV> &V,
