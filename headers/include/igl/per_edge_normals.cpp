...
IGL_INLINE void igl::per_edge_normals(
    ...
    const Eigen::MatrixBase<DerivedFN> &FN, Eigen::PlainObjectBase<DerivedN> &N,
    Eigen::PlainObjectBase<DerivedE> &E,
    Eigen::PlainObjectBase<DerivedEMAP> &EMAP)

{
    static_assert(
        (DerivedEMAP::RowsAtCompileTime == 1 ||
         DerivedEMAP::ColsAtCompileTime == 1),
...
IGL_INLINE void igl::per_edge_normals(
    const Eigen::MatrixBase<DerivedV> &V, const Eigen::MatrixBase<DerivedF> &F,
    const PerEdgeNormalsWeightingType weighting,
    Eigen::PlainObjectBase<DerivedN> &N, Eigen::PlainObjectBase<DerivedE> &E,
    Eigen::PlainObjectBase<DerivedEMAP> &EMAP)
{
...
template void igl::per_edge_normals<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 2, 0, -1, 2>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template void igl::per_edge_normals<
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    Eigen::Matrix<double, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> const &,
...
template void igl::per_edge_normals<
    ...
    Eigen::Matrix<float, -1, 3, 0, -1, 3>, Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, -1, 3, 0, -1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 0, -1, 3>> const &,
    igl::PerEdgeNormalsWeightingType,
