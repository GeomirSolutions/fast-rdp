...
template <typename Derivedsource, typename Deriveddir, typename DerivedV,
          typename DerivedF>
IGL_INLINE bool
ray_triangle_intersect(const Eigen::MatrixBase<Derivedsource> &s,
                       ...
                       igl::Hit &hit)
{
    ...
    double t, u, v;
    if (intersect_triangle1(s_d.data(), dir_d.data(), v0.data(), v1.data(),
                            v2.data(), &t, &u, &v) &&
        t > 0) {
        hit = {static_cast<int>(f), static_cast<int>(-1), static_cast<float>(u),
               static_cast<float>(v), static_cast<float>(t)};
        return true;
    }
...
template <typename Derivedsource, typename Deriveddir, typename DerivedV,
          typename DerivedF>
IGL_INLINE bool ray_mesh_intersect(const Eigen::MatrixBase<Derivedsource> &s,
                                   const Eigen::MatrixBase<Deriveddir> &dir,
                                   const Eigen::MatrixBase<DerivedV> &V,
...
template bool igl::ray_mesh_intersect<
    Eigen::Matrix<float, 1, 3, 1, 1, 3>, Eigen::Matrix<float, 1, 3, 1, 1, 3>,
    Eigen::Matrix<float, -1, -1, 0, -1, -1>,
    Eigen::Block<Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 1, -1, false>>(
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Block<Eigen::Matrix<int, -1, -1, 0, -1, -1> const,
                                   1, -1, false>> const &,
    std::vector<igl::Hit, std::allocator<igl::Hit>> &);
// generated by autoexplicit.sh
template bool igl::ray_mesh_intersect<Eigen::Matrix<float, 3, 1, 0, 3, 1>,
