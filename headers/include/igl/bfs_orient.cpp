...
IGL_INLINE void igl::bfs_orient(const Eigen::MatrixBase<DerivedF> &F,
    ...
    parallel_for(
        ...
        [&](const int c) {
            ...
            while (!Q.empty()) {
                ...
                for (typename SparseMatrix<
                         typename DerivedF::Scalar>::InnerIterator it(A, f);
                     it; ++it) {
