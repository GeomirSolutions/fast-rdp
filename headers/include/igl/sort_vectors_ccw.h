...
/// in the original unordered set, of the vectors in the ordered set (called
/// here the "inverse" set of indices).
///
/// @param[in] P  1 by 3N row vector of the vectors to be sorted, stacked
/// horizontally
/// @param[in] N  #1 by 3 normal of the plane where the vectors lie
/// @param[out] order  N by 1 order of the vectors (indices of the unordered
/// vectors into
///   the ordered vector set)
/// @param[out] sorted  1 by 3N row vector of the ordered vectors, stacked
/// horizontally
