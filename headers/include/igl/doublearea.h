...
///     MatrixXi)
/// @tparam  DeriveddblA  derived type of eigen matrix for dblA (e.g. derived
/// from
///     MatrixXd)
/// @param[in] V  #V by dim list of mesh vertex positions
/// @param[in] F  #F by simplex_size list of mesh faces (must be triangles or
/// quads)
/// @param[out] dblA  #F list of triangle[quad] double areas (SIGNED only for 2D
/// input)
///
...
IGL_INLINE void doublearea(const Eigen::MatrixBase<DerivedV> &V,
...
template <typename DerivedA, typename DerivedB, typename DerivedC,
          typename DerivedD>
IGL_INLINE void doublearea(const Eigen::MatrixBase<DerivedA> &A,
...
doublearea_single(const Eigen::MatrixBase<DerivedA> &A,
                  const Eigen::MatrixBase<DerivedB> &B,
                  const Eigen::MatrixBase<DerivedC> &C);
...
/// @param[in] nan_replacement  what value should be used for triangles whose
/// given
...
IGL_INLINE void doublearea(const Eigen::MatrixBase<Derivedl> &l,
...
/// \fileinfo
template <typename DerivedV, typename DerivedF, typename DeriveddblA>
IGL_INLINE void doublearea_quad(const Eigen::MatrixBase<DerivedV> &V,
                                const Eigen::MatrixBase<DerivedF> &F,
                                Eigen::PlainObjectBase<DeriveddblA> &dblA);
} // namespace igl
