...
/// @param[out] A  vector<vector<T> > containing at row i the adjacent vertices
/// of vertex i
/// @param[in] sorted  flag that indicates if the list should be sorted
/// counter-clockwise. Input assumed to be manifold.
///
/// Example:
/// \code{.cpp}
///   // Mesh in (V,F)
