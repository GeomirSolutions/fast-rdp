...
enum MassMatrixType
{
    ...
    /// Use MASSMATRIX_TYPE_VORONOI for triangles and
    /// MASSMATRIX_TYPE_BARYCENTRIC for tetrahedra
...
///     MASSMATRIX_TYPE_VORONOI voronoi-hybrid {default for triangles, not
///     implemented for tetrahedra} MASSMATRIX_TYPE_FULL full
