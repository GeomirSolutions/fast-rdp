...
//  @param[out] FM #tuple list containing (vertex index, normal index, texture
//  coordinates index, material)
...
/// closed)
template <typename Scalar, typename Index>
IGL_INLINE bool readOBJ(FILE *obj_file, std::vector<std::vector<Scalar>> &V,
                        std::vector<std::vector<Scalar>> &TC,
