...
IGL_INLINE void igl::massmatrix_intrinsic(const Eigen::MatrixBase<Derivedl> &l,
                                          ...
                                          Eigen::SparseMatrix<Scalar> &M)
{
    ...
    case MASSMATRIX_TYPE_VORONOI: {
        ...
        barycentric = (barycentric.array().colwise() /
                       barycentric.array().rowwise().sum())
                          .eval();
    ...
    case MASSMATRIX_TYPE_FULL:
        ...
        MI << F.col(0), F.col(1), F.col(1), F.col(2), F.col(2), F.col(0),
            F.col(0), F.col(1), F.col(2);
        MJ << F.col(1), F.col(0), F.col(2), F.col(1), F.col(0), F.col(2),
            F.col(0), F.col(1), F.col(2);
        repmat(dblA, 9, 1, MV);
...
template void
igl::massmatrix_intrinsic<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
