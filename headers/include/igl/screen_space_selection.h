...
/// @param[in] proj  4 by 4 camera projection matrix (perspective or
/// orthoraphic)
...
/// @param[out] and_visible  #V by 1 list of visibility values (only correct for
/// vertices
///     with |W|>0.5)
...
IGL_INLINE void
screen_space_selection(const Eigen::MatrixBase<DerivedV> &V,
