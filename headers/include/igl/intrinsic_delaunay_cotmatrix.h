...
/// @param[out] l_intrinsic  #F by 3 list of intrinsic edge-lengths used to
/// compute L
/// @param[out] F_intrinsic  #F by 3 list of intrinsic face indices used to
/// compute L
///
/// \see intrinsic_delaunay_triangulation, cotmatrix, cotmatrix_intrinsic
template <typename DerivedV, typename DerivedF, typename Scalar,
          typename Derivedl_intrinsic, typename DerivedF_intrinsic>
...
template <typename DerivedV, typename DerivedF, typename Scalar>
IGL_INLINE void
intrinsic_delaunay_cotmatrix(const Eigen::MatrixBase<DerivedV> &V,
