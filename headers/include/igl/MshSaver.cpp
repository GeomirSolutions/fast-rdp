...
IGL_INLINE igl::MshSaver::~MshSaver() { fout.close(); }

IGL_INLINE void igl::MshSaver::save_mesh(const FloatVector &nodes,
...
IGL_INLINE void igl::MshSaver::save_scalar_field(const std::string &fieldname,
...
IGL_INLINE void igl::MshSaver::save_vector_field(const std::string &fieldname,
                                                 const FloatVector &field)
{
...
IGL_INLINE void
igl::MshSaver::save_elem_scalar_field(const std::string &fieldname,
                                      const FloatVector &field)
{
...
IGL_INLINE void
igl::MshSaver::save_elem_vector_field(const std::string &fieldname,
                                      const FloatVector &field)
{
...
IGL_INLINE void
igl::MshSaver::save_elem_tensor_field(const std::string &fieldname,
                                      const FloatVector &field)
{
