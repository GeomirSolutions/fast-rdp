                              ...
                              Derivedvol &vol)
{
    ...
    for (int f = 0; f < m; f++) {
        ...
        // [Nuernberg 2013] http://www2.imperial.ac.uk/~rn/centroid.pdf rename
        // corners
...
template void igl::centroid<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<float, 3, 1, 0, 3, 1>> &, float &);
// generated by autoexplicit.sh
template void igl::centroid<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
                            Eigen::Matrix<unsigned int, -1, 3, 1, -1, 3>,
