...
/// @param[in] V  #V by dim list of vertex positions, lesser index of E(e,:)
/// will be set
///     to midpoint of edge.
...
/// @param[in] e  index into E of attempted collapsed edge. Set to -1 if Q is
/// empty or
...
using decimate_pre_collapse_callback = std::function<bool(
    const Eigen::MatrixXd &,                             /*V*/
    const Eigen::MatrixXi &,                             /*F*/
    const Eigen::MatrixXi &,                             /*E*/
    const Eigen::VectorXi &,                             /*EMAP*/
...
using decimate_post_collapse_callback = std::function<void(
    const Eigen::MatrixXd &,                             /*V*/
    const Eigen::MatrixXi &,                             /*F*/
    const Eigen::MatrixXi &,                             /*E*/
    const Eigen::VectorXi &,                             /*EMAP*/
