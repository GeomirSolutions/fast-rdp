...
/// @param[in] pd flag specifying whether A(unknown,unknown) is positive
/// definite
/// @param[in,out]  data  factorization struct with all necessary information to
/// solve
...
IGL_INLINE bool
min_quad_with_fixed_precompute(const Eigen::SparseMatrix<T> &A,
...
/// @param[in] data  factorization struct with all necessary precomputation to
/// solve
...
/// @param[in] A  #A by #H list of linear equality constraint coefficients, must
/// be
...
/// \overload
///
/// \brief Special wrapper where the number of constrained values (i.e., true
/// values in k) is exposed as a template parameter. Not intended to be called
