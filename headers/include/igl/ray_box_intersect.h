...
namespace igl
{
/// Determine whether a ray origin+t*dir and box intersect within the ray's
/// parameterized range (t0,t1)
///
...
IGL_INLINE bool
ray_box_intersect(const Eigen::MatrixBase<Derivedsource> &source,
                  const Eigen::MatrixBase<Deriveddir> &dir,
                  const Eigen::AlignedBox<Scalar, 3> &box, const Scalar &t0,
                  const Scalar &t1, Scalar &tmin, Scalar &tmax);
/// \overload
