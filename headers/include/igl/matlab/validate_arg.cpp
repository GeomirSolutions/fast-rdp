...
IGL_INLINE void igl::matlab::validate_arg_scalar(const int i, const int nrhs,
                                                 const mxArray *prhs[],
                                                 const char *name)
{
...
IGL_INLINE void igl::matlab::validate_arg_logical(const int i, const int nrhs,
                                                  const mxArray *prhs[],
                                                  const char *name)
{
    requires_arg(i, nrhs, name);
...
IGL_INLINE void igl::matlab::validate_arg_char(const int i, const int nrhs,
                                               const mxArray *prhs[],
                                               const char *name)
{
    requires_arg(i, nrhs, name);
...
IGL_INLINE void igl::matlab::validate_arg_double(const int i, const int nrhs,
                                                 const mxArray *prhs[],
                                                 const char *name)
{
    requires_arg(i, nrhs, name);
                                                          ...
                                                          const char *name)
{
    requires_arg(i, nrhs, name);
    mexErrMsgTxt(
        mxIsClass(prhs[i + 1], "function_handle"),
