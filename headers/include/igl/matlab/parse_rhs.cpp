                              ...
                              Eigen::PlainObjectBase<DerivedV> &V)
{
    ...
    V = Map<Matrix<double, Dynamic, Dynamic>>(mxGetPr(prhs[0]), mxGetM(prhs[0]),
                                              mxGetN(prhs[0]))
...
template void igl::matlab::parse_rhs_index<Eigen::Matrix<int, -1, 3, 1, -1, 3>>(
    mxArray_tag const **,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> &);
template void
igl::matlab::parse_rhs_double<Eigen::Matrix<double, -1, 3, 1, -1, 3>>(
    mxArray_tag const **,
...
igl::matlab::parse_rhs_double<Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void
igl::matlab::parse_rhs_double<Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    mxArray_tag const **,
