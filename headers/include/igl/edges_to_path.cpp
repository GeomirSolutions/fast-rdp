...
template <typename DerivedE, typename DerivedI, typename DerivedJ,
          typename DerivedK>
IGL_INLINE void igl::edges_to_path(const Eigen::MatrixBase<DerivedE> &OE,
                                   ...
                                   Eigen::PlainObjectBase<DerivedK> &K)
{
    ...
    Eigen::Matrix<typename DerivedI::Scalar, Eigen::Dynamic, 2> sEI;
    {
        Eigen::MatrixXi _;
        sort(E, 2, true, sE, _);
        Eigen::Matrix<typename DerivedI::Scalar, Eigen::Dynamic, 2> EI(
            I.size() - 1, 2);
...
template void igl::edges_to_path<
