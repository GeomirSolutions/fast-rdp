...
/// @param[in] E #E by 2 list of vertex ids forming unoriented edges of the
/// boundary of the polygon
/// @param[in] H #H by 2 coordinates of points contained inside holes of the
/// polygon
/// @param[in] VM #V list of markers for input vertices
/// @param[in] EM #E list of markers for input edges
/// @param[in] flags  string of options pass to triangle (see triangle
/// documentation)
/// @param[out] V2  #V2 by 2  coordinates of the vertives of the generated
/// triangulation
/// @param[out] F2  #F2 by 3  list of indices forming the faces of the generated
/// triangulation
...
template <typename DerivedV, typename DerivedE, typename DerivedH,
          ...
          typename DerivedEM2>
IGL_INLINE void triangulate(const Eigen::MatrixBase<DerivedV> &V,
