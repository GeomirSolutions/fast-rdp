                                   ...
                                   Eigen::PlainObjectBase<DerivedJ> &J)
{
    ...
    WE = E;
    Eigen::VectorXi _;
    igl::remove_duplicate_vertices(DerivedWV(WV), DerivedWE(WE), 1e-10, WV, _,
                                   J, WE);
    // Remove degenerate edges
    const Eigen::Array<bool, Eigen::Dynamic, 1> keep =
        (WE.array().col(0) != WE.array().col(1));
...
template void igl::triangle::cdt<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
