...
///
/// \note that we actually use the Turbo colormap instead, since jet is a bad
/// colormap:
...
IGL_INLINE void jet(const Eigen::MatrixBase<DerivedZ> &Z, const bool normalize,
                    Eigen::PlainObjectBase<DerivedC> &C);
/// \overload
/// @param[in] min_z  value at blue
/// @param[in] max_z  value at red
template <typename DerivedZ, typename DerivedC>
IGL_INLINE void jet(const Eigen::MatrixBase<DerivedZ> &Z, const double min_Z,
                    const double max_Z, Eigen::PlainObjectBase<DerivedC> &C);
}; // namespace igl
