...
/// @param[in] F  #F by dim list of mesh facets as indices into rows of V. If
/// dim==2,
...
template <typename DerivedV, typename DerivedF, typename DerivedO,
          typename DerivedW>
IGL_INLINE void winding_number(const Eigen::MatrixBase<DerivedV> &V,
...
winding_number(const Eigen::MatrixBase<DerivedV> &V,
               const Eigen::MatrixBase<DerivedF> &F,
