    ...
    case 2: {
        ...
        D = (R.col(0).array() * S.col(1).array() -
             R.col(1).array() * S.col(0).array())
                .template cast<typename DerivedD::Scalar>();
        break;
    }
    default: {
...
igl::doublearea_single(const Eigen::MatrixBase<DerivedA> &A,
                       const Eigen::MatrixBase<DerivedB> &B,
                       const Eigen::MatrixBase<DerivedC> &C)
{
...
IGL_INLINE void igl::doublearea(const Eigen::MatrixBase<Derivedl> &ul,
                                Eigen::PlainObjectBase<DeriveddblA> &dblA)
{
                                ...
                                Eigen::PlainObjectBase<DeriveddblA> &dblA)
{
    ...
    parallel_for(
        ...
        [&l, &dblA, &nan_replacement](const int i) {
            ...
            const Scalar arg = (l(i, 0) + (l(i, 1) + l(i, 2))) *
                               (l(i, 2) - (l(i, 0) - l(i, 1))) *
                               (l(i, 2) + (l(i, 0) - l(i, 1))) *
                               (l(i, 0) + (l(i, 1) - l(i, 2)));
            ...
            // nearly degenerate triangles the round-off error during
            // side-length computation may be larger than (or rather smaller)
            // than the height of the triangle. In "Lecture Notes on Geometric
            // Robustness" Shewchuck 09, Section 3.1
            // http://www.cs.berkeley.edu/~jrs/meshpapers/robnotes.pdf, he
            // recommends computing the triangle areas for 2D and 3D using 2D
            // signed areas computed with determinants.
            assert((nan_replacement == nan_replacement ||
                    (l(i, 2) - (l(i, 0) - l(i, 1))) >= 0) &&
                                     ...
                                     Eigen::PlainObjectBase<DeriveddblA> &dblA)
{
    ...
    // Compute areas
    Eigen::Matrix<typename DeriveddblA::Scalar, Eigen::Dynamic, 1>
        doublearea_tri;
...
// generated by autoexplicit.sh
template void igl::doublearea<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<int, -1, -1, 0, -1, -1>,
...
template void igl::doublearea<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void igl::doublearea<Eigen::Matrix<double, -1, 2, 0, -1, 2>,
                              Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 2, 0, -1, 2>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void igl::doublearea<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                              Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 1, -1, -1>> const &,
    Eigen::Matrix<double, -1, -1, 1, -1, -1>::Scalar,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void igl::doublearea<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
...
template void igl::doublearea<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 3, 1, -1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
template void igl::doublearea<
    Eigen::Matrix<float, 1, 3, 1, 1, 3>, Eigen::Matrix<float, 1, 3, 1, 1, 3>,
    Eigen::Matrix<float, 1, 3, 1, 1, 3>, Eigen::Matrix<double, 1, 1, 0, 1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 1, 3, 1, 1, 3>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 1, 0, 1, 1>> &);
...
igl::doublearea_single<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                       Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                       Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
...
igl::doublearea_single<Eigen::Matrix<double, 2, 1, 0, 2, 1>,
                       ...
                       Eigen::Matrix<double, 2, 1, 0, 2, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<double, 2, 1, 0, 2, 1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 2, 1, 0, 2, 1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 2, 1, 0, 2, 1>> const &);
#endif
