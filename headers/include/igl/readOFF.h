...
IGL_INLINE bool
readOFF(const std::string off_file_name, std::vector<std::vector<Scalar>> &V,
        std::vector<std::vector<Index>> &F, std::vector<std::vector<Scalar>> &N,
...
template <typename Scalar, typename Index>
IGL_INLINE bool readOFF(FILE *off_file, std::vector<std::vector<Scalar>> &V,
