                                      ...
                                      Eigen::PlainObjectBase<DerivedIC> &IC)
{
    ...
    parallel_for(
        ...
        [&F, &IA, &FF](size_t &i) {
            FF.row(i) =
                F.row(IA(i)).template cast<typename DerivedFF::Scalar>();
        },
        1000ul);
}
...
template void
igl::unique_simplices<Eigen::Matrix<unsigned int, -1, 2, 0, -1, 2>,
                      Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                      Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                      Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<unsigned int, -1, 2, 0, -1, 2>> const &,
...
#ifdef WIN32
template void
igl::unique_simplices<class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                      class Eigen::Matrix<int, -1, 2, 0, -1, 2>,
                      class Eigen::Matrix<__int64, -1, 1, 0, -1, 1>,
                      class Eigen::Matrix<__int64, -1, 1, 0, -1, 1>>(
    class Eigen::MatrixBase<class Eigen::Matrix<int, -1, 2, 0, -1, 2>> const &,
