...
template <typename DerivedA, typename DerivedU, typename DerivedG,
          typename DerivedJ>
IGL_INLINE void
igl::unzip_corners(const std::vector<std::reference_wrapper<DerivedA>> &A,
...
template void igl::unzip_corners<Eigen::Matrix<int, -1, -1, 0, -1, -1> const,
                                 Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                 Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                 Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    std::vector<
        std::reference_wrapper<Eigen::Matrix<int, -1, -1, 0, -1, -1> const>,
        std::allocator<std::reference_wrapper<
            Eigen::Matrix<int, -1, -1, 0, -1, -1> const>>> const &,
