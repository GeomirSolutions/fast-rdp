...
IGL_INLINE bool igl::qslim(const Eigen::MatrixXd &V, const Eigen::MatrixXi &F,
                           ...
                           Eigen::VectorXi &I)
{
    ...
    bool ret =
        decimate(VO, FO, cost_and_placement,
                 max_faces_stopping_condition(m, orig_m, max_m), pre_collapse,
                 post_collapse, E, EMAP, EF, EI, U, G, J, I);
