...
///   @param[in] F  #F by simplex_size list of mesh elements (triangles or
///   tetrahedra)
///   @param[out] L  #V by #V cotangent matrix, each row i corresponding to
///   V(i,:)
///
/// \see
///   adjacency_matrix
...
IGL_INLINE void cotmatrix(const Eigen::MatrixBase<DerivedV> &V,
...
template <typename DerivedV, typename DerivedI, typename DerivedC,
          typename Scalar>
IGL_INLINE void
cotmatrix(const Eigen::MatrixBase<DerivedV> &V,
          const Eigen::MatrixBase<DerivedI> &I,
          const Eigen::MatrixBase<DerivedC> &C, Eigen::SparseMatrix<Scalar> &L,
          Eigen::SparseMatrix<Scalar> &M, Eigen::SparseMatrix<Scalar> &P);
} // namespace igl
