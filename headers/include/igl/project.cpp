...
template <typename DerivedV, typename DerivedM, typename DerivedN,
          typename DerivedO, typename DerivedP>
IGL_INLINE void igl::project(const Eigen::MatrixBase<DerivedV> &V,
                             ...
                             Eigen::PlainObjectBase<DerivedP> &P)
{
    ...
    HV = (HV * model.template cast<PScalar>().transpose() *
          proj.template cast<PScalar>().transpose())
             .eval();
...
template void igl::project<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::project<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
                           Eigen::Matrix<float, 4, 4, 0, 4, 4>,
                           Eigen::Matrix<float, 4, 4, 0, 4, 4>,
                           Eigen::Matrix<float, 4, 1, 0, 4, 1>,
                           Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    const Eigen::MatrixBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> &,
    const Eigen::MatrixBase<Eigen::Matrix<float, 4, 4, 0, 4, 4>> &,
    const Eigen::MatrixBase<Eigen::Matrix<float, 4, 4, 0, 4, 4>> &,
    const Eigen::MatrixBase<Eigen::Matrix<float, 4, 1, 0, 4, 1>> &,
...
template void igl::project<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    const Eigen::MatrixBase<Eigen::Matrix<double, 4, 4, 0, 4, 4>> &,
    const Eigen::MatrixBase<Eigen::Matrix<double, 4, 1, 0, 4, 1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
template void igl::project<
    Eigen::Matrix<double, 3, 1, 0, 3, 1>, Eigen::Matrix<float, 4, 4, 0, 4, 4>,
...
template void igl::project<
    Eigen::Matrix<double, 1, 3, 1, 1, 3>, Eigen::Matrix<float, 4, 4, 0, 4, 4>,
    Eigen::Matrix<float, 4, 4, 0, 4, 4>, Eigen::Matrix<float, 4, 1, 0, 4, 1>,
