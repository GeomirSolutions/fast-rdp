...
IGL_INLINE void igl::circumradius(const Eigen::MatrixBase<DerivedV> &V,
                                  ...
                                  Eigen::PlainObjectBase<DerivedR> &R)
{
    ...
    R = l.col(0).array() * l.col(1).array() * l.col(2).array() /
        (2.0 * A.array());
}

#ifdef IGL_STATIC_LIBRARY
template void igl::circumradius<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
