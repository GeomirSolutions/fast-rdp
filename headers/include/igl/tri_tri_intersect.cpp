...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          ...
          typename DerivedN1>
IGL_INLINE bool
coplanar_tri_tri3d(const Eigen::MatrixBase<DerivedP1> &p1,
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
IGL_INLINE bool
ccw_tri_tri_intersection_2d(const Eigen::MatrixBase<DerivedP1> &p1,
                            const Eigen::MatrixBase<DerivedQ1> &q1,
                            const Eigen::MatrixBase<DerivedR1> &r1,
                            const Eigen::MatrixBase<DerivedP2> &p2,
                            const Eigen::MatrixBase<DerivedQ2> &q2,
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
inline bool _IGL_CHECK_MIN_MAX(const Eigen::MatrixBase<DerivedP1> &p1,
                               const Eigen::MatrixBase<DerivedQ1> &q1,
                               const Eigen::MatrixBase<DerivedR1> &r1,
                               const Eigen::MatrixBase<DerivedP2> &p2,
                               const Eigen::MatrixBase<DerivedQ2> &q2,
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2,
          typename DP2, typename DQ2, typename DR2, typename DerivedN1>
inline bool _IGL_TRI_TRI_3D(const Eigen::MatrixBase<DerivedP1> &p1,
                            const Eigen::MatrixBase<DerivedQ1> &q1,
                            const Eigen::MatrixBase<DerivedR1> &r1,
                            const Eigen::MatrixBase<DerivedP2> &p2,
                            const Eigen::MatrixBase<DerivedQ2> &q2,
                            const Eigen::MatrixBase<DerivedR2> &r2, DP2 dp2,
                            DQ2 dq2, DR2 dr2,
                            const Eigen::MatrixBase<DerivedP2> &N1)
{
    if (dp2 > 0.0) {
        if (dq2 > 0.0)
            return _IGL_CHECK_MIN_MAX(p1, r1, q1, r2, p2, q2);
        else if (dr2 > 0.0)
            return _IGL_CHECK_MIN_MAX(p1, r1, q1, q2, r2, p2);
        else
            return _IGL_CHECK_MIN_MAX(p1, q1, r1, p2, q2, r2);
    } else if (dp2 < 0.0) {
        if (dq2 < 0.0)
            return _IGL_CHECK_MIN_MAX(p1, q1, r1, r2, p2, q2);
        else if (dr2 < 0.0)
            return _IGL_CHECK_MIN_MAX(p1, q1, r1, q2, r2, p2);
        else
            return _IGL_CHECK_MIN_MAX(p1, r1, q1, p2, q2, r2);
    } else {
        if (dq2 < 0.0) {
            if (dr2 >= 0.0)
                return _IGL_CHECK_MIN_MAX(p1, r1, q1, q2, r2, p2);
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
IGL_INLINE bool
igl::tri_tri_overlap_test_3d(const Eigen::MatrixBase<DerivedP1> &p1,
                             const Eigen::MatrixBase<DerivedQ1> &q1,
                             const Eigen::MatrixBase<DerivedR1> &r1,
                             const Eigen::MatrixBase<DerivedP2> &p2,
                             const Eigen::MatrixBase<DerivedQ2> &q2,
                             const Eigen::MatrixBase<DerivedR2> &r2)
{
    ...
    if (dp1 > 0.0) {
        if (dq1 > 0.0)
            return _IGL_TRI_TRI_3D(r1, p1, q1, p2, r2, q2, dp2, dr2, dq2, N1);
        else if (dr1 > 0.0)
            return _IGL_TRI_TRI_3D(q1, r1, p1, p2, r2, q2, dp2, dr2, dq2, N1);
        else
            return _IGL_TRI_TRI_3D(p1, q1, r1, p2, q2, r2, dp2, dq2, dr2, N1);
    } else if (dp1 < 0.0) {
        if (dq1 < 0.0)
            return _IGL_TRI_TRI_3D(r1, p1, q1, p2, q2, r2, dp2, dq2, dr2, N1);
        else if (dr1 < 0.0)
            return _IGL_TRI_TRI_3D(q1, r1, p1, p2, q2, r2, dp2, dq2, dr2, N1);
        else
            return _IGL_TRI_TRI_3D(p1, q1, r1, p2, r2, q2, dp2, dr2, dq2, N1);
    } else {
        if (dq1 < 0.0) {
            if (dr1 >= 0.0)
                return _IGL_TRI_TRI_3D(q1, r1, p1, p2, r2, q2, dp2, dr2, dq2,
                                       N1);
            else
                return _IGL_TRI_TRI_3D(p1, q1, r1, p2, q2, r2, dp2, dq2, dr2,
                                       N1);
        } else if (dq1 > 0.0) {
            if (dr1 > 0.0)
                return _IGL_TRI_TRI_3D(p1, q1, r1, p2, r2, q2, dp2, dr2, dq2,
                                       N1);
            else
                return _IGL_TRI_TRI_3D(q1, r1, p1, p2, q2, r2, dp2, dq2, dr2,
                                       N1);
        } else {
            if (dr1 > 0.0)
                return _IGL_TRI_TRI_3D(r1, p1, q1, p2, q2, r2, dp2, dq2, dr2,
                                       N1);
            else if (dr1 < 0.0)
                return _IGL_TRI_TRI_3D(r1, p1, q1, p2, r2, q2, dp2, dr2, dq2,
                                       N1);
            else
                return coplanar_tri_tri3d(p1, q1, r1, p2, q2, r2, N1);
        }
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          ...
          typename DerivedN1>
IGL_INLINE bool
igl::internal::coplanar_tri_tri3d(const Eigen::MatrixBase<DerivedP1> &p1,
                                  const Eigen::MatrixBase<DerivedQ1> &q1,
                                  const Eigen::MatrixBase<DerivedR1> &r1,
                                  const Eigen::MatrixBase<DerivedP2> &p2,
                                  const Eigen::MatrixBase<DerivedQ2> &q2,
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2,
          typename DerivedS, typename DerivedT, typename DerivedN1,
          typename DerivedN2>
bool _IGL_CONSTRUCT_INTERSECTION(const Eigen::MatrixBase<DerivedP1> &p1,
                                 const Eigen::MatrixBase<DerivedQ1> &q1,
                                 const Eigen::MatrixBase<DerivedR1> &r1,
                                 const Eigen::MatrixBase<DerivedP2> &p2,
                                 const Eigen::MatrixBase<DerivedQ2> &q2,
                                 ...
                                 const Eigen::MatrixBase<DerivedN2> &N2)
{
    using Scalar = typename DerivedP1::Scalar;
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2,
          typename DP2, typename DQ2, typename DR2, typename DerivedS,
          typename DerivedT, typename DerivedN1, typename DerivedN2>
inline bool _IGL_TRI_TRI_INTER_3D(const Eigen::MatrixBase<DerivedP1> &p1,
                                  const Eigen::MatrixBase<DerivedQ1> &q1,
                                  const Eigen::MatrixBase<DerivedR1> &r1,
                                  const Eigen::MatrixBase<DerivedP2> &p2,
                                  const Eigen::MatrixBase<DerivedQ2> &q2,
                                  const Eigen::MatrixBase<DerivedR2> &r2,
                                  DP2 dp2, DQ2 dq2, DR2 dr2, bool &coplanar,
                                  Eigen::MatrixBase<DerivedS> &source,
                                  Eigen::MatrixBase<DerivedT> &target,
                                  const Eigen::MatrixBase<DerivedN1> &N1,
                                  const Eigen::MatrixBase<DerivedN2> &N2)
{
    if (dp2 > 0.0) {
        if (dq2 > 0.0)
            return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, r2, p2, q2, source,
                                               target, N1, N2);
        else if (dr2 > 0.0)
            return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, q2, r2, p2, source,
                                               target, N1, N2);
        else
            return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, p2, q2, r2, source,
                                               target, N1, N2);
    } else if (dp2 < 0.0) {
        if (dq2 < 0.0)
            return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, r2, p2, q2, source,
                                               target, N1, N2);
        else if (dr2 < 0.0)
            return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, q2, r2, p2, source,
                                               target, N1, N2);
        else
            return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, p2, q2, r2, source,
                                               target, N1, N2);
    } else {
        if (dq2 < 0.0) {
            if (dr2 >= 0.0)
                return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, q2, r2, p2,
                                                   source, target, N1, N2);
            else
                return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, p2, q2, r2,
                                                   source, target, N1, N2);
        } else if (dq2 > 0.0) {
            if (dr2 > 0.0)
                return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, p2, q2, r2,
                                                   source, target, N1, N2);
            else
                return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, q2, r2, p2,
                                                   source, target, N1, N2);
        } else {
            if (dr2 > 0.0)
                return _IGL_CONSTRUCT_INTERSECTION(p1, q1, r1, r2, p2, q2,
                                                   source, target, N1, N2);
            else if (dr2 < 0.0)
                return _IGL_CONSTRUCT_INTERSECTION(p1, r1, q1, r2, p2, q2,
                                                   source, target, N1, N2);
            else {
                coplanar = true;
                return igl::internal::coplanar_tri_tri3d(p1, q1, r1, p2, q2, r2,
                                                         N1);
            }
        }
    }
...
IGL_INLINE bool igl::tri_tri_intersection_test_3d(
    ...
    const Eigen::MatrixBase<DerivedP2> &p2,
    const Eigen::MatrixBase<DerivedQ2> &q2,
    const Eigen::MatrixBase<DerivedR2> &r2, bool &coplanar,
    Eigen::MatrixBase<DerivedS> &source, Eigen::MatrixBase<DerivedT> &target)
{
    ...
    if (dp1 > 0.0) {
        if (dq1 > 0.0)
            return internal::_IGL_TRI_TRI_INTER_3D(r1, p1, q1, p2, r2, q2, dp2,
                                                   dr2, dq2, coplanar, source,
                                                   target, N1, N2);
        else if (dr1 > 0.0)
            return internal::_IGL_TRI_TRI_INTER_3D(q1, r1, p1, p2, r2, q2, dp2,
                                                   dr2, dq2, coplanar, source,
                                                   target, N1, N2);

        else
            return internal::_IGL_TRI_TRI_INTER_3D(p1, q1, r1, p2, q2, r2, dp2,
                                                   dq2, dr2, coplanar, source,
                                                   target, N1, N2);
    } else if (dp1 < 0.0) {
        if (dq1 < 0.0)
            return internal::_IGL_TRI_TRI_INTER_3D(r1, p1, q1, p2, q2, r2, dp2,
                                                   dq2, dr2, coplanar, source,
                                                   target, N1, N2);
        else if (dr1 < 0.0)
            return internal::_IGL_TRI_TRI_INTER_3D(q1, r1, p1, p2, q2, r2, dp2,
                                                   dq2, dr2, coplanar, source,
                                                   target, N1, N2);
        else
            return internal::_IGL_TRI_TRI_INTER_3D(p1, q1, r1, p2, r2, q2, dp2,
                                                   dr2, dq2, coplanar, source,
                                                   target, N1, N2);
    } else {
        if (dq1 < 0.0) {
            if (dr1 >= 0.0)
                return internal::_IGL_TRI_TRI_INTER_3D(q1, r1, p1, p2, r2, q2,
                                                       dp2, dr2, dq2, coplanar,
                                                       source, target, N1, N2);
            else
                return internal::_IGL_TRI_TRI_INTER_3D(p1, q1, r1, p2, q2, r2,
                                                       dp2, dq2, dr2, coplanar,
                                                       source, target, N1, N2);
        } else if (dq1 > 0.0) {
            if (dr1 > 0.0)
                return internal::_IGL_TRI_TRI_INTER_3D(p1, q1, r1, p2, r2, q2,
                                                       dp2, dr2, dq2, coplanar,
                                                       source, target, N1, N2);
            else
                return internal::_IGL_TRI_TRI_INTER_3D(q1, r1, p1, p2, q2, r2,
                                                       dp2, dq2, dr2, coplanar,
                                                       source, target, N1, N2);
        } else {
            if (dr1 > 0.0)
                return internal::_IGL_TRI_TRI_INTER_3D(r1, p1, q1, p2, q2, r2,
                                                       dp2, dq2, dr2, coplanar,
                                                       source, target, N1, N2);
            else if (dr1 < 0.0)
                return internal::_IGL_TRI_TRI_INTER_3D(r1, p1, q1, p2, r2, q2,
                                                       dp2, dr2, dq2, coplanar,
                                                       source, target, N1, N2);
            else {
...
//#define _IGL_ORIENT_2D(a, b, c)
//((a[0]-c[0])*(b[1]-c[1])-(a[1]-c[1])*(b[0]-c[0]))
template <typename DerivedA, typename DerivedB, typename DerivedC>
inline typename Eigen::MatrixBase<DerivedA>::Scalar
_IGL_ORIENT_2D(const Eigen::MatrixBase<DerivedA> &a,
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
bool _IGL_INTERSECTION_TEST_VERTEX(const Eigen::MatrixBase<DerivedP1> &P1,
                                   const Eigen::MatrixBase<DerivedQ1> &Q1,
                                   const Eigen::MatrixBase<DerivedR1> &R1,
                                   const Eigen::MatrixBase<DerivedP2> &P2,
                                   const Eigen::MatrixBase<DerivedQ2> &Q2,
                                   const Eigen::MatrixBase<DerivedR2> &R2)
{
    if (_IGL_ORIENT_2D(R2, P2, Q1) >= 0.0)
        if (_IGL_ORIENT_2D(R2, Q2, Q1) <= 0.0)
        ...
        else if (_IGL_ORIENT_2D(P1, Q2, Q1) <= 0.0)
            ...
            return false;
    else if (_IGL_ORIENT_2D(R2, P2, R1) >= 0.0)
        if (_IGL_ORIENT_2D(Q1, R1, R2) >= 0.0)
            if (_IGL_ORIENT_2D(P1, P2, R1) >= 0.0)
                return true;
            else
                return false;
        else if (_IGL_ORIENT_2D(Q1, R1, Q2) >= 0.0) {
            if (_IGL_ORIENT_2D(R2, R1, Q2) >= 0.0)
                return true;
            else
                return false;
        } else
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
bool _IGL_INTERSECTION_TEST_EDGE(const Eigen::MatrixBase<DerivedP1> &P1,
                                 const Eigen::MatrixBase<DerivedQ1> &Q1,
                                 const Eigen::MatrixBase<DerivedR1> &R1,
                                 const Eigen::MatrixBase<DerivedP2> &P2,
                                 const Eigen::MatrixBase<DerivedQ2> & /*Q2*/,
                                 const Eigen::MatrixBase<DerivedR2> &R2)
{
    if (_IGL_ORIENT_2D(R2, P2, Q1) >= 0.0) {
        if (_IGL_ORIENT_2D(P1, P2, Q1) >= 0.0) {
            if (_IGL_ORIENT_2D(P1, Q1, R2) >= 0.0)
                return true;
            else
                return false;
        } else {
            if (_IGL_ORIENT_2D(Q1, R1, P2) >= 0.0) {
                if (_IGL_ORIENT_2D(R1, P1, P2) >= 0.0)
                    return true;
                else
                    return false;
            } else
        ...
        if (_IGL_ORIENT_2D(R2, P2, R1) >= 0.0) {
            if (_IGL_ORIENT_2D(P1, P2, R1) >= 0.0) {
                if (_IGL_ORIENT_2D(P1, R1, R2) >= 0.0)
                    return true;
                else {
                    if (_IGL_ORIENT_2D(Q1, R1, R2) >= 0.0)
                        return true;
    ...
    if (_IGL_ORIENT_2D(p2, q2, p1) >= 0.0) {
        if (_IGL_ORIENT_2D(q2, r2, p1) >= 0.0) {
            if (_IGL_ORIENT_2D(r2, p2, p1) >= 0.0)
                ...
                return _IGL_INTERSECTION_TEST_EDGE(p1, q1, r1, p2, q2, r2);
        } else {
            if (_IGL_ORIENT_2D(r2, p2, p1) >= 0.0)
                return _IGL_INTERSECTION_TEST_EDGE(p1, q1, r1, r2, p2, q2);
            else
                return _IGL_INTERSECTION_TEST_VERTEX(p1, q1, r1, p2, q2, r2);
        }
    } else {
        if (_IGL_ORIENT_2D(q2, r2, p1) >= 0.0) {
            if (_IGL_ORIENT_2D(r2, p2, p1) >= 0.0)
                ...
                return _IGL_INTERSECTION_TEST_VERTEX(p1, q1, r1, q2, r2, p2);
        } else
            return _IGL_INTERSECTION_TEST_VERTEX(p1, q1, r1, r2, p2, q2);
    }
};
...
template <typename DerivedP1, typename DerivedQ1, typename DerivedR1,
          typename DerivedP2, typename DerivedQ2, typename DerivedR2>
IGL_INLINE bool
igl::tri_tri_overlap_test_2d(const Eigen::MatrixBase<DerivedP1> &p1,
                             const Eigen::MatrixBase<DerivedQ1> &q1,
                             const Eigen::MatrixBase<DerivedR1> &r1,
                             const Eigen::MatrixBase<DerivedP2> &p2,
                             const Eigen::MatrixBase<DerivedQ2> &q2,
                             const Eigen::MatrixBase<DerivedR2> &r2)
{
    if (igl::internal::_IGL_ORIENT_2D(p1, q1, r1) < 0.0)
        if (igl::internal::_IGL_ORIENT_2D(p2, q2, r2) < 0.0)
            return igl::internal::ccw_tri_tri_intersection_2d(p1, r1, q1, p2,
                                                              r2, q2);
        else
            return igl::internal::ccw_tri_tri_intersection_2d(p1, r1, q1, p2,
                                                              q2, r2);
    else if (igl::internal::_IGL_ORIENT_2D(p2, q2, r2) < 0.0)
        return igl::internal::ccw_tri_tri_intersection_2d(p1, q1, r1, p2, r2,
                                                          q2);
    else
        return igl::internal::ccw_tri_tri_intersection_2d(p1, q1, r1, p2, q2,
                                                          r2);
};
...
template bool igl::tri_tri_intersection_test_3d<
...
template bool igl::tri_tri_intersection_test_3d<
    ...
    Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> const &, bool &,
    Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &,
    Eigen::MatrixBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &);
#endif
