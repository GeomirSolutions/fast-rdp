...
template <typename DerivedF, typename DerivedEMAP, typename DeriveduEC,
          typename DeriveduEE, typename DerivedP>
IGL_INLINE size_t
igl::extract_manifold_patches(const Eigen::MatrixBase<DerivedF> &F,
...
IGL_INLINE size_t igl::extract_manifold_patches(
    const Eigen::MatrixBase<DerivedF> &F, Eigen::PlainObjectBase<DerivedP> &P)
{
    Eigen::MatrixXi E, uE;
    Eigen::VectorXi EMAP;
...
template size_t igl::extract_manifold_patches<
...
// generated by autoexplicit.sh
template size_t
igl::extract_manifold_patches<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                              Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template size_t igl::extract_manifold_patches<
    Eigen::Matrix<int, -1, -1, 0, -1, -1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    unsigned long, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template size_t igl::extract_manifold_patches<
    Eigen::Matrix<int, -1, 3, 1, -1, 3>, Eigen::Matrix<int, -1, 1, 0, -1, 1>,
    unsigned long, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
#ifdef WIN32
template uint64_t
igl::extract_manifold_patches<class Eigen::Matrix<int, -1, -1, 0, -1, -1>,
    ...
    class Eigen::MatrixBase<class Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    class std::vector<
        class std::vector<uint64_t, class std::allocator<uint64_t>>,
        class std::allocator<
            class std::vector<uint64_t, class std::allocator<uint64_t>>>> const
        &,
    class Eigen::PlainObjectBase<class Eigen::Matrix<int, -1, 1, 0, -1, 1>> &);
template uint64_t
igl::extract_manifold_patches<class Eigen::Matrix<int, -1, 3, 1, -1, 3>,
                              class Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                              uint64_t,
                              class Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
