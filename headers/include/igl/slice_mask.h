...
IGL_INLINE void slice_mask(const Eigen::SparseMatrix<XType> &X,
...
///
/// @param[int] dim  dimension to slice in 1 or 2, dim=1 --> X(R,:), dim=2 -->
/// X(:,R)
template <typename XType, typename YType>
IGL_INLINE void slice_mask(const Eigen::SparseMatrix<XType> &X,
                           const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
...
IGL_INLINE void slice_mask(const Eigen::DenseBase<DerivedX> &X,
                           const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
                           const Eigen::Array<bool, Eigen::Dynamic, 1> &C,
...
IGL_INLINE void slice_mask(const Eigen::DenseBase<DerivedX> &X,
                           const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
                           const int dim, Eigen::PlainObjectBase<DerivedY> &Y);
/// \overload
...
IGL_INLINE DerivedX slice_mask(const Eigen::DenseBase<DerivedX> &X,
                               const Eigen::Array<bool, Eigen::Dynamic, 1> &R,
                               const Eigen::Array<bool, Eigen::Dynamic, 1> &C);
/// \overload
template <typename DerivedX>
