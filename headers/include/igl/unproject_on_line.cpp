                            ...
                            typename DerivedUV::Scalar &t)
{
    ...
    const Matrix<Scalar, 1, 1> t_mat =
        D.jacobiSvd(ComputeFullU | ComputeFullV).solve(-C);
    t = t_mat(0, 0);
}
...
template void igl::unproject_on_line<
    Eigen::Matrix<double, -1, 1, 0, 3, 1>, Eigen::Matrix<float, 4, 4, 0, 4, 4>,
    Eigen::Matrix<float, 4, 1, 0, 4, 1>, Eigen::Matrix<double, 3, 1, 0, 3, 1>,
...
template void igl::unproject_on_line<
    ...
    Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<double, 3, 1, 0, 3, 1>> const &,
    Eigen::Matrix<double, 2, 1, 0, 2, 1>::Scalar &);
#endif
