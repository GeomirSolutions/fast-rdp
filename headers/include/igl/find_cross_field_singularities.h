...
/// @param[in] mismatch         #F by 3 eigen Matrix containing the integer
/// mismatch of the cross field
///                    across all face edges
/// @param[out] isSingularity    #V by 1 boolean eigen Vector indicating the
/// presence of a singularity on a vertex
/// @param[out] singularityIndex #V by 1 integer eigen Vector containing the
/// singularity indices
///
...
///
/// @param[in] PD1              #F by 3 eigen Matrix of the first per face cross
/// field vector
/// @param[in] PD2              #F by 3 eigen Matrix of the second per face
/// cross field vector
/// @param[in] isCombed        boolean indicating whether the cross field is
/// combed
///
