...
template void igl::squared_edge_lengths<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
...
template void
igl::squared_edge_lengths<Eigen::Matrix<float, -1, -1, 0, -1, -1>,
                          Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                          Eigen::Matrix<float, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<float, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
...
// generated by autoexplicit.sh
template void igl::squared_edge_lengths<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
                                        Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                                        Eigen::Matrix<float, -1, 3, 0, -1, 3>>(
...
// generated by autoexplicit.sh
template void
igl::squared_edge_lengths<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                          Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                          Eigen::Matrix<double, -1, 6, 0, -1, 6>>(
...
igl::squared_edge_lengths<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 3, 0, -1, 3>> &);
template void
igl::squared_edge_lengths<Eigen::Matrix<float, -1, 3, 1, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<float, -1, 3, 0, -1, 3>> &);
template void
igl::squared_edge_lengths<Eigen::Matrix<float, -1, 2, 0, -1, 2>,
...
template void igl::squared_edge_lengths<Eigen::Matrix<double, -1, 2, 0, -1, 2>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 2, 0, -1, 2>> &);
template void
igl::squared_edge_lengths<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                          Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                          Eigen::Matrix<double, -1, 6, 0, -1, 6>>(
...
template void igl::squared_edge_lengths<Eigen::Matrix<double, -1, 3, 0, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, 6, 0, -1, 6>> &);
template void
igl::squared_edge_lengths<Eigen::Matrix<double, -1, 3, 1, -1, 3>,
                          Eigen::Matrix<unsigned int, -1, -1, 1, -1, -1>,
                          Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
