...
template <typename Derivedwin, typename Derivedmodel, typename Derivedproj,
          typename Derivedviewport, typename Derivedscene>
IGL_INLINE void
igl::unproject(const Eigen::MatrixBase<Derivedwin> &win,
               ...
               Eigen::PlainObjectBase<Derivedscene> &scene)
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        Eigen::Matrix<Scalar, 4, 4> Inverse =
            (proj.template cast<Scalar>() * model.template cast<Scalar>())
                .inverse();
...
template void igl::unproject<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
...
template void igl::unproject<
    ...
    Eigen::MatrixBase<Eigen::Matrix<float, 3, 1, 0, 3, 1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 4, 4, 0, 4, 4>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 4, 4, 0, 4, 4>> const &,
    Eigen::MatrixBase<Eigen::Matrix<float, 4, 1, 0, 4, 1>> const &,
...
template void igl::unproject<
    Eigen::Matrix<float, 1, 3, 1, 1, 3>, Eigen::Matrix<float, 4, 4, 0, 4, 4>,
    Eigen::Matrix<float, 4, 4, 0, 4, 4>, Eigen::Matrix<float, 4, 1, 0, 4, 1>,
