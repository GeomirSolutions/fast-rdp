...
IGL_INLINE void igl::path_to_edges(const Eigen::MatrixBase<DerivedI> &I,
...
IGL_INLINE void igl::path_to_edges(const std::vector<Index> &I,
                                   Eigen::PlainObjectBase<DerivedE> &E,
                                   bool make_loop)
{
    igl::path_to_edges(
        Eigen::Map<const Eigen::Matrix<Index, -1, 1>>(I.data(), I.size()), E,
        make_loop);
}

#ifdef IGL_STATIC_LIBRARY
template void igl::path_to_edges<Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                                 Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &, bool);
template void igl::path_to_edges<int, Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
