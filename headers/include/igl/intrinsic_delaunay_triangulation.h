...
/// @param[in] F_in  #F_in by 3 list of face indices into some unspecified
/// vertex list V
/// @param[out] l  #F by 3 list of edge lengths
/// @param[out] F  #F by 3 list of new face indices. Note: Combinatorially F may
/// contain
...
template <typename Derivedl_in, typename DerivedF_in, typename Derivedl,
          typename DerivedF>
IGL_INLINE void
intrinsic_delaunay_triangulation(const Eigen::MatrixBase<Derivedl_in> &l_in,
                                 const Eigen::MatrixBase<DerivedF_in> &F_in,
                                 Eigen::PlainObjectBase<Derivedl> &l,
                                 Eigen::PlainObjectBase<DerivedF> &F);
/// \overload
/// @param[out] E  #F*3 by 2 list of all directed edges, such that E.row(f+#F*c)
/// is the
/// @param[out]   edge opposite F(f,c)
/// @param[out] uE  #uE by 2 list of unique undirected edges
/// @param[out] EMAP #F*3 list of indices into uE, mapping each directed edge to
/// unique
