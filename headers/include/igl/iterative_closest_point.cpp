...
template <typename DerivedVX, typename DerivedFX, typename DerivedVY,
          typename DerivedFY, typename DerivedR, typename Derivedt>
IGL_INLINE void
igl::iterative_closest_point(const Eigen::MatrixBase<DerivedVX> &VX,
                             const Eigen::MatrixBase<DerivedFX> &FX,
                             const Eigen::MatrixBase<DerivedVY> &VY,
                             const Eigen::MatrixBase<DerivedFY> &FY,
                             const int num_samples, const int max_iters,
                             ...
                             Eigen::PlainObjectBase<Derivedt> &t)
{
    ...
    return iterative_closest_point(VX, FX, VY, FY, Ytree, NY, num_samples,
                                   max_iters, R, t);
}

template <typename DerivedVX, typename DerivedFX, typename DerivedVY,
          typename DerivedFY, typename DerivedNY, typename DerivedR,
          typename Derivedt>
IGL_INLINE void
igl::iterative_closest_point(const Eigen::MatrixBase<DerivedVX> &VX,
                             const Eigen::MatrixBase<DerivedFX> &FX,
...
template void
igl::iterative_closest_point<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
    ...
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> const &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &, int, int,
