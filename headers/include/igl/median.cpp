...
template bool
igl::median<Eigen::Block<Eigen::Matrix<float, -1, -1, 0, -1, -1>, -1, 1, true>,
            float>(
...
// generated by autoexplicit.sh
template bool
igl::median<Eigen::Block<Eigen::Matrix<double, -1, -1, 0, -1, -1>, -1, 1, true>,
            double>(
    Eigen::MatrixBase<Eigen::Block<Eigen::Matrix<double, -1, -1, 0, -1, -1>, -1,
                                   1, true>> const &,
    double &);
template bool igl::median<Eigen::Matrix<double, -1, 1, 0, -1, 1>, double>(
