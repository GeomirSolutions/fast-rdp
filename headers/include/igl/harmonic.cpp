                              ...
                              const int k, Eigen::PlainObjectBase<DerivedW> &W)
{
    ...
    igl::sum(A, 1, Asum);
    // Eigen 3.4 still struggles to do arithmetic with sparse and diagonal
    // matrices
    Eigen::SparseMatrix<Scalar> L =
        A - Eigen::SparseMatrix<Scalar>(Asum.asDiagonal());
...
template <typename DerivedL, typename DerivedM, typename Derivedb,
          typename Derivedbc, typename DerivedW>
IGL_INLINE bool igl::harmonic(const Eigen::SparseCompressedBase<DerivedL> &L,
                              ...
                              const int k, Eigen::PlainObjectBase<DerivedW> &W)
{
    ...
    min_quad_with_fixed_precompute(Q, b, Eigen::SparseMatrix<Scalar>(), true,
                                   data);
    W.resize(n, bc.cols());
    typedef Eigen::Matrix<typename Derivedbc::Scalar, Eigen::Dynamic, 1>
        VectorXS;
...
IGL_INLINE void igl::harmonic(const Eigen::SparseCompressedBase<DerivedL> &L,
                              const Eigen::SparseCompressedBase<DerivedM> &M,
...
// generated by autoexplicit.sh
template bool igl::harmonic<Eigen::Matrix<double, -1, -1, 1, -1, -1>,
                            Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                            Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
...
// generated by autoexplicit.sh
template bool igl::harmonic<Eigen::Matrix<int, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<int, -1, 1, 0, -1, 1>,
                            Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<double, -1, -1, 0, -1, -1>>(
    Eigen::MatrixBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> const &,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void igl::harmonic<Eigen::Matrix<double, -1, -1, 0, -1, -1>,
                            Eigen::Matrix<int, -1, -1, 0, -1, -1>,
