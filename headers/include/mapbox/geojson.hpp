...
// Parse inputs of known types. Instantiations are provided for geometry,
...
// Stringify inputs of known types. Instantiations are provided for geometry,
// feature, and feature_collection.
template <class T> std::string stringify(const T &);
